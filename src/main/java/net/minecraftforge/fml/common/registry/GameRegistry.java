...
//            generator.generate(fmlRandom, chunkX, chunkZ, world, chunkGenerator, chunkProvider);
    ...
    {
        return registerBlock(block, block.func_149732_F());
    }
    ...
    {
        return registerBlock(block, itemclass, block.func_149732_F());
    }
    ...
    {
        return registerBlock(block, itemclass, block.func_149732_F(), itemCtorArgs);
    }
    ...
    public static ItemStack makeItemStack(String itemName, int meta, int stackSize, String nbtString)
    {
        ...
        Item item = GameData.getItemRegistry().func_82594_a(new ResourceLocation(itemName));
        if (item == null)
        {
