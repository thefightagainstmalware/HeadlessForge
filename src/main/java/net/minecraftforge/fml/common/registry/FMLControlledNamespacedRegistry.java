...
*/
     ...
     */
    @Override
    public I func_82594_a(ResourceLocation name)
    {
     ...
     */
    @Override
    public boolean func_148741_d(ResourceLocation name)
    {
    ...
    public void notifyCallbacks()
    {
        ...
        {
            addCallback.onAdd(i, this.underlyingIntegerMap.func_148747_b(i));
        }
    }
