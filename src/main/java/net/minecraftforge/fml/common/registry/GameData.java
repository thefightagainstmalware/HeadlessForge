...
public class GameData
{
    ...
    {
        return getMain().iItemRegistry.func_82594_a(new ResourceLocation(modId, name));
    }

    static Block findBlock(String modId, String name)
    {
        return getMain().iBlockRegistry.func_82594_a(new ResourceLocation(modId, name));
    }
...
//                BLOCK_TO_ITEM.forcePut(itemBlock.getBlock().field_149771_c.get(), item);
            }
        }
    }
    ...
    private static class PotionArrayCapture implements FMLControlledNamespacedRegistry.AddCallback<Potion>
    {
        ...
        public void onAdd(Potion potion, int id) {
            ...
            potion.field_76415_H = id;
            Potion.field_76425_a[id] = potion;
        }
    }
}