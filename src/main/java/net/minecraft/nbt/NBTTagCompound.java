...
public class NBTTagCompound extends NBTBase
{
    ...
    public byte getByte(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0 : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getByte();
        }
    ...
    public short func_74765_d(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0 : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getShort();
        }
        catch (ClassCastException var3)
        {
            return (short)0;
    ...
    public int getInteger(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0 : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getInt();
        }
        catch (ClassCastException var3)
        {
            return 0;
    ...
    public long getLong(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0L : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getLong();
        }
        catch (ClassCastException var3)
        {
            return 0L;
    ...
    public float getFloat(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0.0F : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getFloat();
        }
        catch (ClassCastException var3)
        {
            return 0.0F;
    ...
    public double getDouble(String key)
    {
        try
        {
            return !this.func_150297_b(key, 99) ? 0.0D : ((NBTBase.NBTPrimitive)this.tagMap.get(key)).getDouble();
        }
        catch (ClassCastException var3)
        {
            return 0.0D;
    ...
    public String getString(String key)
    {
        try
        {
            return !this.func_150297_b(key, 8) ? "" : ((NBTBase)this.tagMap.get(key)).getString();
        }
        catch (ClassCastException var3)
        {
            return "";
    ...
    public byte[] getByteArray(String key)
    {
        try
        {
            return !this.func_150297_b(key, 7) ? new byte[0] : ((NBTTagByteArray)this.tagMap.get(key)).getByteArray();
        }
    ...
    public int[] getIntArray(String key)
    {
        try
        {
            return !this.func_150297_b(key, 11) ? new int[0] : ((NBTTagIntArray)this.tagMap.get(key)).getIntArray();
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public NBTTagCompound func_74775_l(String key)
    {
        try
        {
            return !this.func_150297_b(key, 10) ? new NBTTagCompound() : (NBTTagCompound)this.tagMap.get(key);
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public NBTTagList getTagList(String key, int type)
    {
        try
        {
            ...
            else
            {
                ...
                return nbttaglist.func_74745_c() > 0 && nbttaglist.getTagType() != type ? new NBTTagList() : nbttaglist;
            }
        }
        catch (ClassCastException classcastexception)
        {
    ...
    public NBTBase func_74737_b()
    {
        ...
        for (String s : this.tagMap.keySet())
        {
            nbttagcompound.func_74782_a(s, ((NBTBase)this.tagMap.get(s)).func_74737_b());
        }
     ...
     */
    public void func_179237_a(NBTTagCompound other)
    {
