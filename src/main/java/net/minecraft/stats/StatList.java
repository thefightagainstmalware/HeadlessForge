...
public class StatList
{
    ...
    private static void initCraftableStats()
    {
        ...
        for (IRecipe irecipe : CraftingManager.getInstance().getRecipeList())
        {
            ...
            {
                set.add(irecipe.getRecipeOutput().func_77973_b());
            }
        }
        ...
        for (Item item : set)
        {
            if (item != null)
            {
                ...
                if (s != null)
                {
                    objectCraftStats[i] = (new StatCrafting("stat.craftItem.", s, new ChatComponentTranslation("stat.craftItem", new Object[] {(new ItemStack(item)).func_151000_E()}), item)).registerStat();
                }
            }
        }
    ...
    private static void initMiningStats()
    {
        for (Block block : Block.field_149771_c)
        {
            ...
            if (item != null)
            {
                ...
                {
                    mineBlockStatArray[i] = (new StatCrafting("stat.mineBlock.", s, new ChatComponentTranslation("stat.mineBlock", new Object[] {(new ItemStack(block)).func_151000_E()}), item)).registerStat();
    ...
    private static void initStats()
    {
        for (Item item : Item.field_150901_e)
        {
            if (item != null)
            {
                ...
                if (s != null)
                {
                    objectUseStats[i] = (new StatCrafting("stat.useItem.", s, new ChatComponentTranslation("stat.useItem", new Object[] {(new ItemStack(item)).func_151000_E()}), item)).registerStat();
    ...
    private static void initItemDepleteStats()
    {
        for (Item item : Item.field_150901_e)
        {
            if (item != null)
            {
                ...
                {
                    objectBreakStats[i] = (new StatCrafting("stat.breakItem.", s, new ChatComponentTranslation("stat.breakItem", new Object[] {(new ItemStack(item)).func_151000_E()}), item)).registerStat();
                }
            }
        }
    ...
    {
        ResourceLocation resourcelocation = (ResourceLocation)Item.field_150901_e.getNameForObject(p_180204_0_);
    ...
    {
        mergeStatBases(p_75924_0_, Blocks.field_150355_j, Blocks.field_150358_i);
        mergeStatBases(p_75924_0_, Blocks.lava, Blocks.field_150356_k);
        mergeStatBases(p_75924_0_, Blocks.lit_pumpkin, Blocks.field_150423_aK);
        mergeStatBases(p_75924_0_, Blocks.field_150470_am, Blocks.field_150460_al);
        mergeStatBases(p_75924_0_, Blocks.field_150439_ay, Blocks.field_150450_ax);
        mergeStatBases(p_75924_0_, Blocks.field_150416_aS, Blocks.field_150413_aR);
        mergeStatBases(p_75924_0_, Blocks.field_150455_bV, Blocks.field_150441_bU);
        ...
        mergeStatBases(p_75924_0_, Blocks.field_150349_c, Blocks.field_150346_d);
        mergeStatBases(p_75924_0_, Blocks.farmland, Blocks.field_150346_d);
    }
    ...
    private static void mergeStatBases(StatBase[] statBaseIn, Block p_151180_1_, Block p_151180_2_)
    {
        ...
        {
            field_75940_b.remove(statBaseIn[i]);
