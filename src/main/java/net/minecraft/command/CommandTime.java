...
public class CommandTime extends CommandBase {
    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
        if(p_71515_2_.length > 1) {
            if(p_71515_2_[0].equals("set")) {
                ...
                func_152373_a(p_71515_1_, this, "commands.time.set", l);
                return;
            }
            ...
            if(p_71515_2_[0].equals("add")) {
                ...
                func_152373_a(p_71515_1_, this, "commands.time.added", k);
                return;
            }
            ...
            if(p_71515_2_[0].equals("query")) {
                if(p_71515_2_[1].equals("daytime")) {
                    ...
                    func_152373_a(p_71515_1_, this, "commands.time.query", j);
                    return;
                }
    ...
    public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
        return p_180525_2_.length == 1?func_71530_a(p_180525_2_, "set", "add", "query"):(p_180525_2_.length == 2 && p_180525_2_[0].equals("set")?func_71530_a(p_180525_2_, new String[]{"day", "night"}):(p_180525_2_.length == 2 && p_180525_2_[0].equals("query")?func_71530_a(p_180525_2_, new String[]{"daytime", "gametime"}):null));
    }
