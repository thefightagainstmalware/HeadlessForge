...
public class CommandWorldBorder extends CommandBase {
    ...
    public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
        return p_180525_2_.length == 1?func_71530_a(p_180525_2_, "set", "center", "damage", "warning", "add", "get"):(p_180525_2_.length == 2 && p_180525_2_[0].equals("damage")?func_71530_a(p_180525_2_, new String[]{"buffer", "amount"}):(p_180525_2_.length >= 2 && p_180525_2_.length <= 3 && p_180525_2_[0].equals("center")?func_181043_b(p_180525_2_, 1, p_180525_3_):(p_180525_2_.length == 2 && p_180525_2_[0].equals("warning")?func_71530_a(p_180525_2_, new String[]{"time", "distance"}):null)));
    }
}
