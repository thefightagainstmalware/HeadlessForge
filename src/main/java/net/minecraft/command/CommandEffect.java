            ...
            if(p_71515_2_[1].equals("clear")) {
                ...
                if(i >= 0 && i < Potion.field_76425_a.length && Potion.field_76425_a[i] != null) {
                    ...
                    if(l > 0) {
                        ...
                        func_152373_a(p_71515_1_, this, "commands.effect.success", new ChatComponentTranslation(potioneffect.func_76453_d(), new Object[0]), Integer.valueOf(i), Integer.valueOf(k), entitylivingbase.func_70005_c_(), Integer.valueOf(l));
                    } else if(entitylivingbase.func_82165_m(i)) {
                        entitylivingbase.func_82170_o(i);
                        func_152373_a(p_71515_1_, this, "commands.effect.success.removed", new ChatComponentTranslation(potion1.func_76393_a(), new Object[0]), entitylivingbase.func_70005_c_());
                    } else {
                        throw new CommandException("commands.effect.failure.notActive", new ChatComponentTranslation(potion1.func_76393_a(), new Object[0]), entitylivingbase.func_70005_c_());
                    }
                } else {
