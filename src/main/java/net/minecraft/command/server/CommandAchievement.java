                    ...
                    if(statbase == null) {
                        ...
                        if(statbase instanceof Achievement) {
                            ...
                            if(flag) {
                                ...
                                for(list = Lists.newArrayList(); achievement.field_75992_c != null && !entityplayermp.func_147099_x().func_77443_a(achievement.field_75992_c); achievement = achievement.field_75992_c) {
