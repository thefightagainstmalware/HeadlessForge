    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
        if(p_71515_2_.length < 1) {
            ...
            if(p_71515_2_[0].equals("on")) {
                ...
                p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.whitelist.list", minecraftserver.func_71203_ab().func_152598_l().length, minecraftserver.func_71203_ab().func_72373_m().length));
