                            ...
                            for(int k = 0; k < nbttaglist.func_74745_c(); ++k) {
                                ...
                                if(Enchantment.func_180306_c(l) != null) {
                                    ...
                                    if(!enchantment2.func_77326_a(enchantment1)) {
                                        throw new CommandException("commands.enchant.cantCombine", enchantment1.func_77316_c(j), enchantment2.func_77316_c(nbttaglist.func_150305_b(k).func_74765_d("lvl")));
                                    }
                                }
                            }
                        }
