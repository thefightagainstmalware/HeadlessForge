...
public class CommandStats extends CommandBase {
        ...
        if(p_71515_2_.length < 1) {
            ...
            if(commandresultstats$type == null) {
                ...
                if(flag) {
                    ...
                    if(tileentity == null) {
                        throw new CommandException("commands.stats.noCompatibleBlock", blockpos.func_177958_n(), blockpos.func_177956_o(), blockpos.func_177952_p());
                    }
                ...
                if("set".equals(s)) {
                    ...
                    func_152373_a(p_71515_1_, this, "commands.stats.success", commandresultstats$type.func_179637_b(), s2, s1);
                } else {
                    CommandResultStats.func_179667_a(commandresultstats, commandresultstats$type, null, null);
                    func_152373_a(p_71515_1_, this, "commands.stats.cleared", commandresultstats$type.func_179637_b());
                }
    ...
    public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
        return p_180525_2_.length == 1?func_71530_a(p_180525_2_, "entity", "block"):(p_180525_2_.length == 2 && p_180525_2_[0].equals("entity")?func_71530_a(p_180525_2_, this.func_175776_d()):(p_180525_2_.length >= 2 && p_180525_2_.length <= 4 && p_180525_2_[0].equals("block")?func_175771_a(p_180525_2_, 1, p_180525_3_):((p_180525_2_.length != 3 || !p_180525_2_[0].equals("entity")) && (p_180525_2_.length != 5 || !p_180525_2_[0].equals("block"))?((p_180525_2_.length != 4 || !p_180525_2_[0].equals("entity")) && (p_180525_2_.length != 6 || !p_180525_2_[0].equals("block"))?((p_180525_2_.length != 6 || !p_180525_2_[0].equals("entity")) && (p_180525_2_.length != 8 || !p_180525_2_[0].equals("block"))?null:func_175762_a(p_180525_2_, this.func_175777_e())):func_71530_a(p_180525_2_, CommandResultStats.Type.func_179634_c())):func_71530_a(p_180525_2_, new String[]{"set", "clear"}))));
    }
