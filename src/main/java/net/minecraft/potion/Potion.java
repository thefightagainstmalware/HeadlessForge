...
public class Potion
{
    ...
    {
        this.field_76415_H = potionID;
        field_76425_a[potionID] = this;
    ...
    public static Potion func_180142_b(String location)
    {
    ...
    {
        if (this.field_76415_H == regeneration.field_76415_H)
        {
        ...
        else if (this.field_76415_H == poison.field_76415_H)
        {
        ...
        else if (this.field_76415_H == wither.field_76415_H)
        {
            entityLivingBaseIn.attackEntityFrom(DamageSource.wither, 1.0F);
        }
        else if (this.field_76415_H == hunger.field_76415_H && entityLivingBaseIn instanceof EntityPlayer)
        {
            ((EntityPlayer)entityLivingBaseIn).addExhaustion(0.025F * (float)(p_76394_2_ + 1));
        }
        else if (this.field_76415_H == saturation.field_76415_H && entityLivingBaseIn instanceof EntityPlayer)
        {
            if (!entityLivingBaseIn.field_70170_p.isRemote)
            {
                ((EntityPlayer)entityLivingBaseIn).getFoodStats().addStats(p_76394_2_ + 1, 1.0F);
            }
        }
        else if ((this.field_76415_H != heal.field_76415_H || entityLivingBaseIn.isEntityUndead()) && (this.field_76415_H != harm.field_76415_H || !entityLivingBaseIn.isEntityUndead()))
        {
            if (this.field_76415_H == harm.field_76415_H && !entityLivingBaseIn.isEntityUndead() || this.field_76415_H == heal.field_76415_H && entityLivingBaseIn.isEntityUndead())
            {
    ...
    {
        if ((this.field_76415_H != heal.field_76415_H || entityLivingBaseIn.isEntityUndead()) && (this.field_76415_H != harm.field_76415_H || !entityLivingBaseIn.isEntityUndead()))
        {
            if (this.field_76415_H == harm.field_76415_H && !entityLivingBaseIn.isEntityUndead() || this.field_76415_H == heal.field_76415_H && entityLivingBaseIn.isEntityUndead())
            {
    ...
    public boolean isReady(int p_76397_1_, int p_76397_2_)
    {
        ...
        {
            return this.field_76415_H == hunger.field_76415_H;
        }
    }
    ...
    public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, BaseAttributeMap p_111185_2_, int amplifier)
    {
        for (Entry<IAttribute, AttributeModifier> entry : this.attributeModifierMap.entrySet())
        {
            ...
            if (iattributeinstance != null)
            {
                ...
                iattributeinstance.applyModifier(new AttributeModifier(attributemodifier.getID(), this.func_76393_a() + " " + amplifier, this.getAttributeModifierAmount(amplifier, attributemodifier), attributemodifier.getOperation()));
            }
        }
    }
