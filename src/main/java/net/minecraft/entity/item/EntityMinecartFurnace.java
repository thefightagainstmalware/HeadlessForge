...
public class EntityMinecartFurnace extends EntityMinecart
{
    ...
    public void onUpdate()
    {
        ...
        {
            this.field_70170_p.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.field_70165_t, this.field_70163_u + 0.8D, this.field_70161_v, 0.0D, 0.0D, 0.0D, new int[0]);
        }
    }
    ...
    public void killMinecart(DamageSource p_94095_1_)
    {
        ...
        if (!p_94095_1_.isExplosion() && this.field_70170_p.func_82736_K().func_82766_b("doEntityDrops"))
        {
    ...
    public boolean interactFirst(EntityPlayer playerIn)
    {
        ...
        this.pushX = this.field_70165_t - playerIn.field_70165_t;
        this.pushZ = this.field_70161_v - playerIn.field_70161_v;
        return true;
    }
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        this.fuel = tagCompund.func_74765_d("Fuel");
    }
    ...
    {
        return (this.isMinecartPowered() ? Blocks.field_150470_am : Blocks.field_150460_al).func_176223_P().withProperty(BlockFurnace.FACING, EnumFacing.NORTH);
    }
