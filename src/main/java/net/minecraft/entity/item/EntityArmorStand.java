...
public class EntityArmorStand extends EntityLivingBase
{
    ...
    public boolean func_174820_d(int inventorySlot, ItemStack itemStackIn)
    {
        ...
        if (itemStackIn != null && EntityLiving.getArmorPosition(itemStackIn) != i && (i != 4 || !(itemStackIn.func_77973_b() instanceof ItemBlock)))
        {
            return false;
        }
        else
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        tagCompound.func_74768_a("DisabledSlots", this.disabledSlots);
        ...
        tagCompound.func_74782_a("Pose", this.readPoseFromNBT());
    }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        if (tagCompund.func_150297_b("Equipment", 9))
        {
            ...
            for (int i = 0; i < this.contents.length; ++i)
            {
                this.contents[i] = ItemStack.loadItemStackFromNBT(nbttaglist.func_150305_b(i));
            }
        }
        ...
        this.noClip = this.hasNoGravity();
        NBTTagCompound nbttagcompound = tagCompund.func_74775_l("Pose");
    ...
    {
        List<Entity> list = this.field_70170_p.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox());
    ...
    public boolean interactAt(EntityPlayer player, Vec3 targetVec3)
    {
        ...
        else if (!this.field_70170_p.isRemote && !player.isSpectator())
        {
            int i = 0;
            ...
            double d3 = flag1 ? targetVec3.field_72448_b * 2.0D : targetVec3.field_72448_b;
    ...
    private void func_175422_a(EntityPlayer p_175422_1_, int p_175422_2_)
    {
        ...
        if (itemstack == null || (this.disabledSlots & 1 << p_175422_2_ + 8) == 0)
        {
            ...
            {
                int i = p_175422_1_.field_71071_by.currentItem;
                ItemStack itemstack1 = p_175422_1_.field_71071_by.getStackInSlot(i);
        ...
        else if (!this.isEntityInvulnerable(source) && !this.canInteract && !this.func_181026_s())
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (source.getEntity() instanceof EntityPlayer && !((EntityPlayer)source.getEntity()).field_71075_bZ.allowEdit)
                    {
                        return false;
                    }
    ...
    private void playParticles()
    {
        ...
        {
            ((WorldServer)this.field_70170_p).func_180505_a(EnumParticleTypes.BLOCK_DUST, this.field_70165_t, this.field_70163_u + (double)this.height / 1.5D, this.field_70161_v, 10, (double)(this.width / 4.0F), (double)(this.height / 4.0F), (double)(this.width / 4.0F), 0.05D, new int[] {Block.func_176210_f(Blocks.field_150344_f.func_176223_P())});
        }
    }
    ...
    {
        Block.spawnAsEntity(this.field_70170_p, new BlockPos(this), new ItemStack(Items.armor_stand));
        this.dropContents();
    }
    ...
    private void dropContents()
    {
        for (int i = 0; i < this.contents.length; ++i)
        {
            if (this.contents[i] != null && this.contents[i].field_77994_a > 0)
            {
                if (this.contents[i] != null)
                {
                    Block.spawnAsEntity(this.field_70170_p, (new BlockPos(this)).up(), this.contents[i]);
                }
