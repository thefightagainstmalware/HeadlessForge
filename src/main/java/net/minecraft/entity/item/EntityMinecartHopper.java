...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper
{
    ...
    public void onUpdate()
    {
        ...
        if (!this.field_70170_p.isRemote && this.isEntityAlive() && this.getBlocked())
        {
    ...
    public boolean func_96112_aD()
    {
        ...
        {
            List<EntityItem> list = this.field_70170_p.<EntityItem>getEntitiesWithinAABB(EntityItem.class, this.getEntityBoundingBox().expand(0.25D, 0.0D, 0.25D), EntitySelectors.selectAnything);
    ...
    public void killMinecart(DamageSource p_94095_1_)
    {
        ...
        {
            this.dropItemWithOffset(Item.func_150898_a(Blocks.field_150438_bZ), 1, 0.0F);
        }
    }
    ...
    protected void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        tagCompound.func_74768_a("TransferCooldown", this.transferTicker);
    }
