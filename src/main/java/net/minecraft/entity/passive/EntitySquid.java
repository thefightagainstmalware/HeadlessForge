...
public class EntitySquid extends EntityWaterMob
{
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            this.entityDropItem(new ItemStack(Items.field_151100_aR, 1, EnumDyeColor.BLACK.getDyeDamage()), 0.0F);
        }
    }
    ...
    {
        return this.field_70170_p.handleMaterialAcceleration(this.getEntityBoundingBox().expand(0.0D, -0.6000000238418579D, 0.0D), Material.water, this);
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if ((double)this.squidRotation > (Math.PI * 2D))
        {
            ...
            else
            {
                ...
                this.field_70170_p.setEntityState(this, (byte)19);
            }
        }
    ...
    {
        return this.field_70163_u > 45.0D && this.field_70163_u < (double)this.field_70170_p.func_181545_F() && super.getCanSpawnHere();
    }
    ...
    static class AIMoveRandom extends EntityAIBase
    {
        ...
        public void updateTask()
        {
            ...
            else if (this.squid.func_70681_au().nextInt(50) == 0 || !this.squid.inWater || !this.squid.func_175567_n())
            {
                float f = this.squid.func_70681_au().nextFloat() * (float)Math.PI * 2.0F;
