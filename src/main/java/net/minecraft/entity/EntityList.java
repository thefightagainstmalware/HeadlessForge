...
public class EntityList
{
     ...
     */
    public static Entity func_75615_a(NBTTagCompound nbt, World worldIn)
    {
        Entity entity = null;

        if ("Minecart".equals(nbt.getString("id")))
        {
            nbt.func_74778_a("id", EntityMinecart.EnumMinecartType.byNetworkID(nbt.getInteger("Type")).getName());
    ...
    {
        return "Player".equals(entityName) || func_180124_b().contains(entityName);
    }
