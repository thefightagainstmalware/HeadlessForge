...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public void onLivingUpdate()
    {
        if (this.field_70170_p.isRemote)
        {
            ...
            {
                this.field_70170_p.playSound(this.field_70165_t, this.field_70163_u, this.field_70161_v, "mob.enderdragon.wings", 5.0F, 0.8F + this.rand.nextFloat() * 0.3F, false);
            }
        }
        ...
        if (this.getHealth() <= 0.0F)
        {
            ...
            this.field_70170_p.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.field_70165_t + (double)f11, this.field_70163_u + 2.0D + (double)f13, this.field_70161_v + (double)f14, 0.0D, 0.0D, 0.0D, new int[0]);
        }
        else
        {
            this.updateDragonEnderCrystal();
            float f10 = 0.2F / (MathHelper.func_76133_a(this.motionX * this.motionX + this.motionZ * this.motionZ) * 10.0F + 1.0F);
            ...
            else
            {
                ...
                if (this.field_70170_p.isRemote)
                {
                    ...
                    {
                        double d10 = this.field_70165_t + (this.newPosX - this.field_70165_t) / (double)this.newPosRotationIncrements;
                        double d0 = this.field_70163_u + (this.newPosY - this.field_70163_u) / (double)this.newPosRotationIncrements;
                        double d1 = this.field_70161_v + (this.newPosZ - this.field_70161_v) / (double)this.newPosRotationIncrements;
                        double d2 = MathHelper.func_76138_g(this.newRotationYaw - (double)this.field_70177_z);
                        this.field_70177_z = (float)((double)this.field_70177_z + d2 / (double)this.newPosRotationIncrements);
                ...
                else
                {
                    ...
                    Vec3 vec3 = (new Vec3(this.targetX - this.field_70165_t, this.targetY - this.field_70163_u, this.targetZ - this.field_70161_v)).normalize();
                    double d15 = (double)(-MathHelper.cos(this.field_70177_z * (float)Math.PI / 180.0F));
                    Vec3 vec31 = (new Vec3((double)MathHelper.sin(this.field_70177_z * (float)Math.PI / 180.0F), this.motionY, d15)).normalize();
                    ...
                    float f6 = MathHelper.func_76133_a(this.motionX * this.motionX + this.motionZ * this.motionZ) * 1.0F + 1.0F;
                ...
                this.dragonPartBody.func_70012_b(this.field_70165_t + (double)(f16 * 0.5F), this.field_70163_u, this.field_70161_v - (double)(f4 * 0.5F), 0.0F, 0.0F);
                this.dragonPartWing1.onUpdate();
                this.dragonPartWing1.func_70012_b(this.field_70165_t + (double)(f4 * 4.5F), this.field_70163_u + 2.0D, this.field_70161_v + (double)(f16 * 4.5F), 0.0F, 0.0F);
                this.dragonPartWing2.onUpdate();
                this.dragonPartWing2.func_70012_b(this.field_70165_t - (double)(f4 * 4.5F), this.field_70163_u + 2.0D, this.field_70161_v - (double)(f16 * 4.5F), 0.0F, 0.0F);

                if (!this.field_70170_p.isRemote && this.hurtTime == 0)
                {
                    this.collideWithEntities(this.field_70170_p.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartWing1.getEntityBoundingBox().expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
                    this.collideWithEntities(this.field_70170_p.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartWing2.getEntityBoundingBox().expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
                    this.attackEntitiesInList(this.field_70170_p.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartHead.getEntityBoundingBox().expand(1.0D, 1.0D, 1.0D)));
                }

                double[] adouble1 = this.getMovementOffsets(5, 1.0F);
                double[] adouble = this.getMovementOffsets(0, 1.0F);
                float f18 = MathHelper.sin(this.field_70177_z * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
                float f19 = MathHelper.cos(this.field_70177_z * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
                this.dragonPartHead.onUpdate();
                this.dragonPartHead.func_70012_b(this.field_70165_t + (double)(f18 * 5.5F * f2), this.field_70163_u + (adouble[1] - adouble1[1]) * 1.0D + (double)(f15 * 5.5F), this.field_70161_v - (double)(f19 * 5.5F * f2), 0.0F, 0.0F);
    ...
    private void updateDragonEnderCrystal()
    {
        ...
        {
            float f = 32.0F;
            List<EntityEnderCrystal> list = this.field_70170_p.<EntityEnderCrystal>getEntitiesWithinAABB(EntityEnderCrystal.class, this.getEntityBoundingBox().expand((double)f, (double)f, (double)f));
    ...
    private void setNewTarget()
    {
        ...
        List<EntityPlayer> list = Lists.newArrayList(this.field_70170_p.playerEntities);
    ...
    {
        int i = MathHelper.func_76128_c(p_70972_1_.minX);
        int j = MathHelper.func_76128_c(p_70972_1_.minY);
        int k = MathHelper.func_76128_c(p_70972_1_.minZ);
        int l = MathHelper.func_76128_c(p_70972_1_.maxX);
        int i1 = MathHelper.func_76128_c(p_70972_1_.maxY);
        int j1 = MathHelper.func_76128_c(p_70972_1_.maxZ);
        boolean flag = false;
        boolean flag1 = false;
        ...
        for (int k1 = i; k1 <= l; ++k1)
        {
            for (int l1 = j; l1 <= i1; ++l1)
            {
                for (int i2 = k; i2 <= j1; ++i2)
                {
                    ...
                    {
                        if (block != Blocks.field_180401_cv && block != Blocks.field_150343_Z && block != Blocks.end_stone && block != Blocks.field_150357_h && block != Blocks.command_block && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing"))
                        {
                            flag1 = this.field_70170_p.setBlockToAir(blockpos) || flag1;
                        }
                        else
                        {
                            flag = true;
        ...
        if (flag1)
        {
            ...
            this.field_70170_p.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
        }
    ...
    public boolean attackEntityFromPart(EntityDragonPart dragonPart, DamageSource source, float p_70965_3_)
    {
        ...
        this.targetX = this.field_70165_t + (double)(f1 * 5.0F) + (double)((this.rand.nextFloat() - 0.5F) * 2.0F);
        this.targetY = this.field_70163_u + (double)(this.rand.nextFloat() * 3.0F) + 1.0D;
        this.targetZ = this.field_70161_v - (double)(f2 * 5.0F) + (double)((this.rand.nextFloat() - 0.5F) * 2.0F);
        this.target = null;
    ...
    protected void onDeathUpdate()
    {
        ...
        if (this.deathTicks >= 180 && this.deathTicks <= 200)
        {
            ...
            this.field_70170_p.spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.field_70165_t + (double)f, this.field_70163_u + 2.0D + (double)f1, this.field_70161_v + (double)f2, 0.0D, 0.0D, 0.0D, new int[0]);
        }
        ...
        if (!this.field_70170_p.isRemote)
        {
            ...
            {
                this.field_70170_p.playBroadcastSound(1018, new BlockPos(this), 0);
            }
        }

        this.moveEntity(0.0D, 0.10000000149011612D, 0.0D);
        this.renderYawOffset = this.field_70177_z += 20.0F;

        if (this.deathTicks == 200 && !this.field_70170_p.isRemote)
        {
            if (flag)
            {
                int j = 2000;
            ...
            this.generatePortal(new BlockPos(this.field_70165_t, 64.0D, this.field_70161_v));
            this.setDead();
        }
    }
    ...
    private void generatePortal(BlockPos pos)
    {
                ...
                for (int l = -4; l <= 4; ++l)
                {
                    ...
                    if (d2 <= 12.25D)
                    {
                        ...
                        if (j < 0)
                        {
                            if (d2 <= 6.25D)
                            {
                                this.field_70170_p.setBlockState(blockpos, Blocks.field_150357_h.func_176223_P());
                            }
                        }
                        else if (j > 0)
                        {
                            this.field_70170_p.setBlockState(blockpos, Blocks.field_150350_a.func_176223_P());
                        }
                        else if (d2 > 6.25D)
                        {
                            this.field_70170_p.setBlockState(blockpos, Blocks.field_150357_h.func_176223_P());
                        ...
                        {
                            this.field_70170_p.setBlockState(blockpos, Blocks.end_portal.func_176223_P());
                        }
                    }
                }
            }
        ...
        this.field_70170_p.setBlockState(pos, Blocks.field_150357_h.func_176223_P());
        this.field_70170_p.setBlockState(pos.up(), Blocks.field_150357_h.func_176223_P());
        BlockPos blockpos1 = pos.up(2);
        this.field_70170_p.setBlockState(blockpos1, Blocks.field_150357_h.func_176223_P());
        this.field_70170_p.setBlockState(blockpos1.west(), Blocks.torch.func_176223_P().withProperty(BlockTorch.FACING, EnumFacing.EAST));
        this.field_70170_p.setBlockState(blockpos1.east(), Blocks.torch.func_176223_P().withProperty(BlockTorch.FACING, EnumFacing.WEST));
        this.field_70170_p.setBlockState(blockpos1.north(), Blocks.torch.func_176223_P().withProperty(BlockTorch.FACING, EnumFacing.SOUTH));
        this.field_70170_p.setBlockState(blockpos1.south(), Blocks.torch.func_176223_P().withProperty(BlockTorch.FACING, EnumFacing.NORTH));
        this.field_70170_p.setBlockState(pos.up(3), Blocks.field_150357_h.func_176223_P());
        this.field_70170_p.setBlockState(pos.up(4), Blocks.dragon_egg.func_176223_P());
    }
