...
public class EntityPigZombie extends EntityZombie
{
    ...
    protected void updateAITasks()
    {
        ...
        {
            EntityPlayer entityplayer = this.field_70170_p.getPlayerEntityByUUID(this.angerTargetUUID);
    ...
    {
        return this.field_70170_p.getDifficulty() != EnumDifficulty.PEACEFUL;
    }
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        {
            tagCompound.func_74778_a("HurtBy", this.angerTargetUUID.toString());
        }
        else
        {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            this.dropItem(Items.field_151078_bh, 1);
        }
