...
public class EntitySilverfish extends EntityMob
{
    ...
    {
        return this.field_70170_p.func_180495_p(pos.func_177977_b()).func_177230_c() == Blocks.field_150348_b ? 10.0F : super.getBlockPathWeight(pos);
    }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        {
            EntityPlayer entityplayer = this.field_70170_p.getClosestPlayerToEntity(this, 5.0D);
    ...
    static class AIHideInStone extends EntityAIWander
    {
        ...
        public boolean shouldExecute()
        {
            ...
            else
            {
                ...
                if (random.nextInt(10) == 0)
                {
                    ...
                    BlockPos blockpos = (new BlockPos(this.field_179485_a.field_70165_t, this.field_179485_a.field_70163_u + 0.5D, this.field_179485_a.field_70161_v)).offset(this.facing);
        ...
        public void startExecuting()
        {
            ...
            else
            {
                ...
                if (BlockSilverfish.canContainSilverfish(iblockstate))
                {
                    world.func_180501_a(blockpos, Blocks.monster_egg.func_176223_P().withProperty(BlockSilverfish.VARIANT, BlockSilverfish.EnumType.forModelBlock(iblockstate)), 3);
                ...
                for (int i = 0; i <= 5 && i >= -5; i = i <= 0 ? 1 - i : 0 - i)
                {
                    for (int j = 0; j <= 10 && j >= -10; j = j <= 0 ? 1 - j : 0 - j)
                    {
                        for (int k = 0; k <= 10 && k >= -10; k = k <= 0 ? 1 - k : 0 - k)
                        {
                            ...
                            if (iblockstate.func_177230_c() == Blocks.monster_egg)
                            {
                                ...
                                {
                                    world.func_180501_a(blockpos1, ((BlockSilverfish.EnumType)iblockstate.getValue(BlockSilverfish.VARIANT)).getModelBlock(), 3);
                                }
