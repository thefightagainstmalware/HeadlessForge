...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    public void onUpdate()
    {
        ...
        if (!this.field_70170_p.isRemote && this.field_70170_p.getDifficulty() == EnumDifficulty.PEACEFUL)
        {
            this.setDead();
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if ("fireball".equals(source.getDamageType()) && source.getEntity() instanceof EntityPlayer)
        {
            ...
            ((EntityPlayer)source.getEntity()).func_71029_a(AchievementList.ghast);
            return true;
        }
        else
        {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            this.dropItem(Items.field_151073_bk, 1);
        }
    ...
    {
        return this.rand.nextInt(20) == 0 && super.getCanSpawnHere() && this.field_70170_p.getDifficulty() != EnumDifficulty.PEACEFUL;
    }
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < d0 * d0 && this.parentEntity.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.attackTimer == 20)
                {
                    ...
                    double d2 = entitylivingbase.field_70165_t - (this.parentEntity.field_70165_t + vec3.field_72450_a * d1);
                    double d3 = entitylivingbase.getEntityBoundingBox().minY + (double)(entitylivingbase.height / 2.0F) - (0.5D + this.parentEntity.field_70163_u + (double)(this.parentEntity.height / 2.0F));
                    double d4 = entitylivingbase.field_70161_v - (this.parentEntity.field_70161_v + vec3.field_72449_c * d1);
                    world.playAuxSFXAtEntity((EntityPlayer)null, 1008, new BlockPos(this.parentEntity), 0);
                    EntityLargeFireball entitylargefireball = new EntityLargeFireball(world, this.parentEntity, d2, d3, d4);
                    entitylargefireball.explosionPower = this.parentEntity.getFireballStrength();
                    entitylargefireball.field_70165_t = this.parentEntity.field_70165_t + vec3.field_72450_a * d1;
                    entitylargefireball.field_70163_u = this.parentEntity.field_70163_u + (double)(this.parentEntity.height / 2.0F) + 0.5D;
                    entitylargefireball.field_70161_v = this.parentEntity.field_70161_v + vec3.field_72449_c * d1;
    ...
    static class AILookAround extends EntityAIBase
    {
        ...
        public void updateTask()
        {
            ...
            {
                this.parentEntity.renderYawOffset = this.parentEntity.field_70177_z = -((float)MathHelper.func_181159_b(this.parentEntity.motionX, this.parentEntity.motionZ)) * 180.0F / (float)Math.PI;
            }
            else
            {
                EntityLivingBase entitylivingbase = this.parentEntity.getAttackTarget();
                ...
                if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < d0 * d0)
                {
                    ...
                    this.parentEntity.renderYawOffset = this.parentEntity.field_70177_z = -((float)MathHelper.func_181159_b(d1, d2)) * 180.0F / (float)Math.PI;
                }
            }
        }
    }
    ...
    static class AIRandomFly extends EntityAIBase
    {
        ...
        public boolean shouldExecute()
        {
            ...
            {
                double d0 = entitymovehelper.getX() - this.parentEntity.field_70165_t;
                double d1 = entitymovehelper.getY() - this.parentEntity.field_70163_u;
                double d2 = entitymovehelper.getZ() - this.parentEntity.field_70161_v;
    ...
    static class GhastMoveHelper extends EntityMoveHelper
    {
        ...
        public void onUpdateMoveHelper()
        {
            if (this.update)
            {
                double d0 = this.posX - this.parentEntity.field_70165_t;
                double d1 = this.posY - this.parentEntity.field_70163_u;
                double d2 = this.posZ - this.parentEntity.field_70161_v;
                double d3 = d0 * d0 + d1 * d1 + d2 * d2;
        ...
        private boolean isNotColliding(double p_179926_1_, double p_179926_3_, double p_179926_5_, double p_179926_7_)
        {
            ...
            for (int i = 1; (double)i < p_179926_7_; ++i)
            {
                ...
                if (!this.parentEntity.field_70170_p.getCollidingBoundingBoxes(this.parentEntity, axisalignedbb).isEmpty())
                {
                    return false;
                }
            }
