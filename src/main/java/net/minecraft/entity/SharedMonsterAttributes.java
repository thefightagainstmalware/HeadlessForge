...
public class SharedMonsterAttributes
{
    ...
    public static NBTTagList writeBaseAttributeMapToNBT(BaseAttributeMap p_111257_0_)
    {
        ...
        {
            nbttaglist.func_74742_a(writeAttributeInstanceToNBT(iattributeinstance));
        }
    ...
    private static NBTTagCompound writeAttributeInstanceToNBT(IAttributeInstance p_111261_0_)
    {
        ...
        nbttagcompound.func_74778_a("Name", iattribute.getAttributeUnlocalizedName());
        ...
        if (collection != null && !collection.isEmpty())
        {
            ...
            for (AttributeModifier attributemodifier : collection)
            {
                ...
                {
                    nbttaglist.func_74742_a(writeAttributeModifierToNBT(attributemodifier));
                }
            }
    ...
    {
        NBTTagCompound nbttagcompound = new NBTTagCompound();
        nbttagcompound.func_74778_a("Name", p_111262_0_.getName());
        nbttagcompound.setDouble("Amount", p_111262_0_.getAmount());
        nbttagcompound.func_74768_a("Operation", p_111262_0_.getOperation());
    ...
    private static void applyModifiersToAttributeInstance(IAttributeInstance p_111258_0_, NBTTagCompound p_111258_1_)
    {
        ...
        if (p_111258_1_.func_150297_b("Modifiers", 9))
        {
            ...
            {
                AttributeModifier attributemodifier = readAttributeModifierFromNBT(nbttaglist.func_150305_b(i));
