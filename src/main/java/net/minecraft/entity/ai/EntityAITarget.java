...
public abstract class EntityAITarget extends EntityAIBase
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return !(entitylivingbase instanceof EntityPlayer) || !((EntityPlayer)entitylivingbase).field_71075_bZ.disableDamage;
                }
            }
        }
    }
    ...
    public static boolean isSuitableTarget(EntityLiving attacker, EntityLivingBase target, boolean includeInvincibles, boolean checkSight)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if (target instanceof EntityPlayer && !includeInvincibles && ((EntityPlayer)target).field_71075_bZ.disableDamage)
                {
                    return false;
                }
    ...
    private boolean canEasilyReach(EntityLivingBase p_75295_1_)
    {
        ...
        else
        {
            ...
            {
                int i = pathpoint.xCoord - MathHelper.func_76128_c(p_75295_1_.field_70165_t);
                int j = pathpoint.zCoord - MathHelper.func_76128_c(p_75295_1_.field_70161_v);
