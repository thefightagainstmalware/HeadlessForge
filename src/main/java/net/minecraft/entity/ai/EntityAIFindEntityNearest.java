...
public class EntityAIFindEntityNearest extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        List<EntityLivingBase> list = this.field_179442_b.field_70170_p.<EntityLivingBase>getEntitiesWithinAABB(this.field_179439_f, this.field_179442_b.getEntityBoundingBox().expand(d0, 4.0D, d0), this.field_179443_c);
    ...
    public boolean continueExecuting()
    {
        ...
        {
            double d0 = this.func_179438_f();
            return this.field_179442_b.getDistanceSqToEntity(entitylivingbase) > d0 * d0 ? false : !(entitylivingbase instanceof EntityPlayerMP) || !((EntityPlayerMP)entitylivingbase).field_71134_c.func_73083_d();
        }
    }
