...
public abstract class EntityAIMoveToBlock extends EntityAIBase
{
    ...
    {
        return this.timeoutCounter >= -this.field_179490_f && this.timeoutCounter <= 1200 && this.shouldMoveTo(this.theEntity.field_70170_p, this.destinationBlock);
    }
    ...
    {
        this.theEntity.getNavigator().tryMoveToXYZ((double)((float)this.destinationBlock.func_177958_n()) + 0.5D, (double)(this.destinationBlock.func_177956_o() + 1), (double)((float)this.destinationBlock.func_177952_p()) + 0.5D, this.movementSpeed);
            ...
            for (int l = 0; l < i; ++l)
            {
                for (int i1 = 0; i1 <= l; i1 = i1 > 0 ? -i1 : 1 - i1)
                {
                    for (int j1 = i1 < l && i1 > -l ? l : 0; j1 <= l; j1 = j1 > 0 ? -j1 : 1 - j1)
                    {
                        ...
                        if (this.theEntity.isWithinHomeDistanceFromPosition(blockpos1) && this.shouldMoveTo(this.theEntity.field_70170_p, blockpos1))
                        {
