...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public EntityAIFindEntityNearestPlayer(EntityLiving p_i45882_1_)
    {
        ...
        this.field_179435_c = new Predicate<Entity>()
        {
            public boolean apply(Entity p_apply_1_)
            {
                ...
                else if (((EntityPlayer)p_apply_1_).field_71075_bZ.disableDamage)
                {
                    return false;
                }
                else
    ...
    public boolean shouldExecute()
    {
        ...
        List<EntityPlayer> list = this.field_179434_b.field_70170_p.<EntityPlayer>getEntitiesWithinAABB(EntityPlayer.class, this.field_179434_b.getEntityBoundingBox().expand(d0, 4.0D, d0), this.field_179435_c);
    ...
    public boolean continueExecuting()
    {
        ...
        else if (entitylivingbase instanceof EntityPlayer && ((EntityPlayer)entitylivingbase).field_71075_bZ.disableDamage)
        {
            return false;
        }
        else
        {
            ...
            {
                double d0 = this.func_179431_f();
                return this.field_179434_b.getDistanceSqToEntity(entitylivingbase) > d0 * d0 ? false : !(entitylivingbase instanceof EntityPlayerMP) || !((EntityPlayerMP)entitylivingbase).field_71134_c.func_73083_d();
            }
        }
    }
