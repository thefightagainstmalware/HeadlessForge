...
public class ContainerBeacon extends Container
{
    ...
    public void onContainerClosed(EntityPlayer playerIn)
    {
        ...
        if (playerIn != null && !playerIn.field_70170_p.isRemote)
        {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (!this.beaconSlot.getHasStack() && this.beaconSlot.isItemValid(itemstack1) && itemstack1.field_77994_a == 1)
            {
    ...
    class BeaconSlot extends Slot
    {
        ...
        {
            return stack == null ? false : stack.func_77973_b() == Items.emerald || stack.func_77973_b() == Items.field_151045_i || stack.func_77973_b() == Items.gold_ingot || stack.func_77973_b() == Items.iron_ingot;
        }
