...
public class ContainerBrewingStand extends Container
{
    ...
    class Ingredient extends Slot
    {
        ...
        {
            return stack != null ? stack.func_77973_b().isPotionIngredient(stack) : false;
        }
    ...
    static class Potion extends Slot
    {
        ...
        {
            if (stack.func_77973_b() == Items.potionitem && stack.getMetadata() > 0)
            {
                this.player.func_71029_a(AchievementList.potion);
            }
        ...
        {
            return stack != null && (stack.func_77973_b() == Items.potionitem || stack.func_77973_b() == Items.glass_bottle);
        }
    }
}
