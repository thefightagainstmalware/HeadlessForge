...
public class ContainerRepair extends Container
{
    ...
    public ContainerRepair(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player)
    {
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
        {
            ...
            {
                return (playerIn.field_71075_bZ.field_75098_d || playerIn.field_71068_ca >= ContainerRepair.this.maximumCost) && ContainerRepair.this.maximumCost > 0 && this.getHasStack();
            }
            public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack)
            {
                if (!playerIn.field_71075_bZ.field_75098_d)
                {
                    playerIn.func_82242_a(-ContainerRepair.this.maximumCost);
                }

                ContainerRepair.this.inputSlots.func_70299_a(0, (ItemStack)null);

                if (ContainerRepair.this.materialCost > 0)
                {
                    ItemStack itemstack = ContainerRepair.this.inputSlots.getStackInSlot(1);

                    if (itemstack != null && itemstack.field_77994_a > ContainerRepair.this.materialCost)
                    {
                        itemstack.field_77994_a -= ContainerRepair.this.materialCost;
                        ContainerRepair.this.inputSlots.func_70299_a(1, itemstack);
                    }
                    else
                    {
                        ContainerRepair.this.inputSlots.func_70299_a(1, (ItemStack)null);
                    }
                }
                else
                {
                ...
                IBlockState iblockstate = worldIn.func_180495_p(blockPosIn);

                if (!playerIn.field_71075_bZ.field_75098_d && !worldIn.isRemote && iblockstate.func_177230_c() == Blocks.field_150467_bQ && playerIn.func_70681_au().nextFloat() < 0.12F)
                {
                    ...
                    {
                        worldIn.func_180501_a(blockPosIn, iblockstate.withProperty(BlockAnvil.DAMAGE, Integer.valueOf(l)), 2);
    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (itemstack2 != null)
            {
                flag = itemstack2.func_77973_b() == Items.field_151134_bR && Items.field_151134_bR.getEnchantments(itemstack2).func_74745_c() > 0;

                if (itemstack1.isItemStackDamageable() && itemstack1.func_77973_b().getIsRepairable(itemstack, itemstack2))
                {
                ...
                {
                    if (!flag && (itemstack1.func_77973_b() != itemstack2.func_77973_b() || !itemstack1.isItemStackDamageable()))
                    {
                        this.outputSlot.func_70299_a(0, (ItemStack)null);
                        this.maximumCost = 0;
                        return;
                    ...
                    while (iterator1.hasNext())
                    {
                        ...
                        if (enchantment != null)
                        {
                            ...
                            if (this.thePlayer.field_71075_bZ.field_75098_d || itemstack.func_77973_b() == Items.field_151134_bR)
                            {
                                flag1 = true;
                            }
    ...
    {
        return this.theWorld.func_180495_p(this.selfPosition).func_177230_c() != Blocks.field_150467_bQ ? false : playerIn.getDistanceSq((double)this.selfPosition.func_177958_n() + 0.5D, (double)this.selfPosition.func_177956_o() + 0.5D, (double)this.selfPosition.func_177952_p() + 0.5D) <= 64.0D;
    }
