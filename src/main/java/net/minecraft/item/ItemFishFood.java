...
public class ItemFishFood extends ItemFood
{
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        ...
        {
            player.func_70690_d(new PotionEffect(Potion.poison.field_76415_H, 1200, 3));
            player.func_70690_d(new PotionEffect(Potion.hunger.field_76415_H, 300, 2));
            player.func_70690_d(new PotionEffect(Potion.confusion.field_76415_H, 300, 1));
        }
    ...
    public static enum FishType
    {
        ...
        {
            return stack.func_77973_b() instanceof ItemFishFood ? byMetadata(stack.getMetadata()) : COD;
        }
