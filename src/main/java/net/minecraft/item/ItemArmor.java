...
public class ItemArmor extends Item
{
    ...
    {
        return this.material != ItemArmor.ArmorMaterial.LEATHER ? false : (!stack.func_77942_o() ? false : (!stack.func_77978_p().func_150297_b("display", 10) ? false : stack.func_77978_p().func_74775_l("display").func_150297_b("color", 3)));
    }
    ...
    {
        return this.material.getRepairItem() == repair.func_77973_b() ? true : super.getIsRepairable(toRepair, repair);
    }
    ...
    public static enum ArmorMaterial
    {
        ...
        {
            return this == LEATHER ? Items.leather : (this == CHAIN ? Items.iron_ingot : (this == GOLD ? Items.gold_ingot : (this == IRON ? Items.iron_ingot : (this == DIAMOND ? Items.field_151045_i : null))));
        }
