            ...
            else if (enumdyecolor == EnumDyeColor.BROWN)
            {
                ...
                if (block == Blocks.log && iblockstate.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.JUNGLE)
                {
                    ...
                    if (worldIn.func_175623_d(pos))
                    {
                        ...
                        worldIn.func_180501_a(pos, iblockstate1, 2);
    ...
    public static void spawnBonemealParticles(World worldIn, BlockPos pos, int amount)
    {
        ...
        if (block.func_149688_o() != Material.field_151579_a)
        {
            ...
            for (int i = 0; i < amount; ++i)
            {
                ...
                worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, (double)((float)pos.func_177958_n() + itemRand.nextFloat()), (double)pos.func_177956_o() + (double)itemRand.nextFloat() * block.getBlockBoundsMaxY(), (double)((float)pos.func_177952_p() + itemRand.nextFloat()), d0, d1, d2, new int[0]);
            }
        }
    }
