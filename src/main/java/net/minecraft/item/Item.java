...
public class Item
{
    ...
    {
        return itemIn == null ? 0 : field_150901_e.getIDForObject(itemIn);
    }

    public static Item getItemById(int id)
    {
        return (Item) field_150901_e.getObjectById(id);
    }
    ...
    {
        Item item = field_150901_e.func_82594_a(new ResourceLocation(id));
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World worldIn, EntityPlayer playerIn, boolean useLiquids)
    {
        ...
        double d1 = playerIn.field_70163_u + (double)playerIn.getEyeHeight();
    ...
    {
        registerItemBlock(Blocks.field_150348_b, (new ItemMultiTexture(Blocks.field_150348_b, Blocks.field_150348_b, new Function<ItemStack, String>()
        {
        ...
        registerItemBlock(Blocks.field_150349_c, new ItemColored(Blocks.field_150349_c, false));
        registerItemBlock(Blocks.field_150346_d, (new ItemMultiTexture(Blocks.field_150346_d, Blocks.field_150346_d, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        registerItemBlock(Blocks.field_150347_e);
        registerItemBlock(Blocks.field_150344_f, (new ItemMultiTexture(Blocks.field_150344_f, Blocks.field_150344_f, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        registerItemBlock(Blocks.field_150345_g, (new ItemMultiTexture(Blocks.field_150345_g, Blocks.field_150345_g, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
                return BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName();
        ...
        registerItemBlock(Blocks.field_150357_h);
        ...
        registerItemBlock(Blocks.field_150351_n);
        registerItemBlock(Blocks.field_150352_o);
        registerItemBlock(Blocks.field_150366_p);
        registerItemBlock(Blocks.field_150350_a);
        ...
        registerItemBlock(Blocks.field_150369_x);
        registerItemBlock(Blocks.lapis_block);
        registerItemBlock(Blocks.field_150367_z);
        ...
        registerItemBlock(Blocks.field_150330_I);
        registerItemBlock(Blocks.piston, new ItemPiston(Blocks.piston));
        registerItemBlock(Blocks.field_150325_L, (new ItemCloth(Blocks.field_150325_L)).setUnlocalizedName("cloth"));
        ...
        registerItemBlock(Blocks.field_150335_W);
        registerItemBlock(Blocks.bookshelf);
        registerItemBlock(Blocks.mossy_cobblestone);
        registerItemBlock(Blocks.field_150343_Z);
        registerItemBlock(Blocks.torch);
        registerItemBlock(Blocks.mob_spawner);
        registerItemBlock(Blocks.oak_stairs);
        registerItemBlock(Blocks.field_150486_ae);
        registerItemBlock(Blocks.field_150482_ag);
        registerItemBlock(Blocks.field_150484_ah);
        registerItemBlock(Blocks.field_150462_ai);
        registerItemBlock(Blocks.farmland);
        registerItemBlock(Blocks.field_150460_al);
        registerItemBlock(Blocks.field_150470_am);
        registerItemBlock(Blocks.ladder);
        registerItemBlock(Blocks.rail);
        registerItemBlock(Blocks.stone_stairs);
        registerItemBlock(Blocks.field_150442_at);
        registerItemBlock(Blocks.stone_pressure_plate);
        registerItemBlock(Blocks.wooden_pressure_plate);
        registerItemBlock(Blocks.field_150450_ax);
        registerItemBlock(Blocks.redstone_torch);
        registerItemBlock(Blocks.field_150430_aB);
        ...
        registerItemBlock(Blocks.field_150423_aK);
        ...
        registerItemBlock(Blocks.field_150415_aT);
        ...
        registerItemBlock(Blocks.field_150381_bn);
        ...
        registerItemBlock(Blocks.field_150412_bA);
        ...
        registerItemBlock(Blocks.field_150461_bJ);
        ...
        registerItemBlock(Blocks.field_150471_bO);
        registerItemBlock(Blocks.field_150467_bQ, (new ItemAnvilBlock(Blocks.field_150467_bQ)).setUnlocalizedName("anvil"));
        registerItemBlock(Blocks.field_150447_bR);
        registerItemBlock(Blocks.light_weighted_pressure_plate);
        registerItemBlock(Blocks.heavy_weighted_pressure_plate);
        registerItemBlock(Blocks.field_150453_bW);
        registerItemBlock(Blocks.redstone_block);
        registerItemBlock(Blocks.field_150449_bY);
        registerItemBlock(Blocks.field_150438_bZ);
        ...
        registerItemBlock(Blocks.field_150409_cd);
        registerItemBlock(Blocks.field_150406_ce, (new ItemCloth(Blocks.field_150406_ce)).setUnlocalizedName("clayHardenedStained"));
        registerItemBlock(Blocks.field_180401_cv);
        registerItemBlock(Blocks.field_180400_cw);
        ...
        registerItemBlock(Blocks.field_150399_cn, (new ItemCloth(Blocks.field_150399_cn)).setUnlocalizedName("stainedGlass"));
        registerItemBlock(Blocks.stained_glass_pane, (new ItemCloth(Blocks.stained_glass_pane)).setUnlocalizedName("stainedGlassPane"));
        registerItemBlock(Blocks.field_180397_cI, (new ItemMultiTexture(Blocks.field_180397_cI, Blocks.field_180397_cI, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        registerItem(322, "golden_apple", (new ItemAppleGold(4, 1.2F, false)).setAlwaysEdible().setPotionEffect(Potion.regeneration.field_76415_H, 5, 1, 1.0F).setUnlocalizedName("appleGold"));
        registerItem(323, "sign", (new ItemSign()).setUnlocalizedName("sign"));
        registerItem(324, "wooden_door", (new ItemDoor(Blocks.field_180413_ao)).setUnlocalizedName("doorOak"));
        Item item = (new ItemBucket(Blocks.field_150350_a)).setUnlocalizedName("bucket").setMaxStackSize(16);
        registerItem(325, "bucket", item);
        registerItem(326, "water_bucket", (new ItemBucket(Blocks.field_150358_i)).setUnlocalizedName("bucketWater").setContainerItem(item));
        registerItem(327, "lava_bucket", (new ItemBucket(Blocks.field_150356_k)).setUnlocalizedName("bucketLava").setContainerItem(item));
        ...
        registerItem(330, "iron_door", (new ItemDoor(Blocks.field_150454_av)).setUnlocalizedName("doorIron"));
        ...
        registerItem(356, "repeater", (new ItemReed(Blocks.field_150413_aR)).setUnlocalizedName("diode").setCreativeTab(CreativeTabs.tabRedstone));
        ...
        registerItem(365, "chicken", (new ItemFood(2, 0.3F, true)).setPotionEffect(Potion.hunger.field_76415_H, 30, 0, 0.3F).setUnlocalizedName("chickenRaw"));
        registerItem(366, "cooked_chicken", (new ItemFood(6, 0.6F, true)).setUnlocalizedName("chickenCooked"));
        registerItem(367, "rotten_flesh", (new ItemFood(4, 0.1F, true)).setPotionEffect(Potion.hunger.field_76415_H, 30, 0, 0.8F).setUnlocalizedName("rottenFlesh"));
        ...
        registerItem(375, "spider_eye", (new ItemFood(2, 0.8F, false)).setPotionEffect(Potion.poison.field_76415_H, 5, 0, 1.0F).setUnlocalizedName("spiderEye").setPotionEffect(PotionHelper.spiderEyeEffect));
        ...
        registerItem(379, "brewing_stand", (new ItemReed(Blocks.field_150382_bo)).setUnlocalizedName("brewingStand").setCreativeTab(CreativeTabs.tabBrewing));
        ...
        registerItem(394, "poisonous_potato", (new ItemFood(2, 0.3F, false)).setPotionEffect(Potion.poison.field_76415_H, 5, 0, 0.6F).setUnlocalizedName("potatoPoisonous"));
        ...
        registerItem(404, "comparator", (new ItemReed(Blocks.field_150441_bU)).setUnlocalizedName("comparator").setCreativeTab(CreativeTabs.tabRedstone));
        ...
        registerItem(428, "birch_door", (new ItemDoor(Blocks.field_180412_aq)).setUnlocalizedName("doorBirch"));
        registerItem(429, "jungle_door", (new ItemDoor(Blocks.field_180411_ar)).setUnlocalizedName("doorJungle"));
        registerItem(430, "acacia_door", (new ItemDoor(Blocks.field_180410_as)).setUnlocalizedName("doorAcacia"));
        registerItem(431, "dark_oak_door", (new ItemDoor(Blocks.field_180409_at)).setUnlocalizedName("doorDarkOak"));
    ...
    {
        registerItem(Block.func_149682_b(blockIn), (ResourceLocation)Block.field_149771_c.getNameForObject(blockIn), itemIn);
    ...
    {
        field_150901_e.register(id, textualID, itemIn);
    }
    ...
    public static enum ToolMaterial
    {
        ...
        {
            return this == WOOD ? Item.func_150898_a(Blocks.field_150344_f) : (this == STONE ? Item.func_150898_a(Blocks.field_150347_e) : (this == GOLD ? Items.gold_ingot : (this == IRON ? Items.iron_ingot : (this == EMERALD ? Items.field_151045_i : null))));
        }
    }
}
