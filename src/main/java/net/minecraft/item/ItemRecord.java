...
public class ItemRecord extends Item
{
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if (iblockstate.func_177230_c() == Blocks.jukebox && !((Boolean)iblockstate.getValue(BlockJukebox.HAS_RECORD)).booleanValue())
        {
            if (worldIn.isRemote)
            {
                return true;
            ...
            else
            {
                ...
                --stack.field_77994_a;
                playerIn.func_71029_a(StatList.field_181740_X);
                return true;
            }
        }
        else
