...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
                ...
                if (!this.isBurning() && this.canSmelt())
                {
                    ...
                    if (this.isBurning())
                    {
                        ...
                        if (this.furnaceItemStacks[1] != null)
                        {
                            ...
                            {
                                Item item = this.furnaceItemStacks[1].func_77973_b().getContainerItem();
    ...
    private boolean canSmelt()
    {
        ...
        else
        {
            ...
            return itemstack == null ? false : (this.furnaceItemStacks[2] == null ? true : (!this.furnaceItemStacks[2].isItemEqual(itemstack) ? false : (this.furnaceItemStacks[2].field_77994_a < this.getInventoryStackLimit() && this.furnaceItemStacks[2].field_77994_a < this.furnaceItemStacks[2].getMaxStackSize() ? true : this.furnaceItemStacks[2].field_77994_a < itemstack.getMaxStackSize())));
        }
    }
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            if (this.furnaceItemStacks[0].func_77973_b() == Item.func_150898_a(Blocks.sponge) && this.furnaceItemStacks[0].getMetadata() == 1 && this.furnaceItemStacks[1] != null && this.furnaceItemStacks[1].func_77973_b() == Items.bucket)
            {
    ...
    public static int getItemBurnTime(ItemStack p_145952_0_)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.field_150350_a)
            {
            ...
            return item instanceof ItemTool && ((ItemTool)item).getToolMaterialName().equals("WOOD") ? 200 : (item instanceof ItemSword && ((ItemSword)item).getToolMaterialName().equals("WOOD") ? 200 : (item instanceof ItemHoe && ((ItemHoe)item).getMaterialName().equals("WOOD") ? 200 : (item == Items.stick ? 100 : (item == Items.field_151044_h ? 1600 : (item == Items.lava_bucket ? 20000 : (item == Item.func_150898_a(Blocks.field_150345_g) ? 100 : (item == Items.blaze_rod ? 2400 : 0)))))));
        }
    }
    ...
    public boolean canExtractItem(int index, ItemStack stack, EnumFacing direction)
    {
        if (direction == EnumFacing.DOWN && index == 1)
        {
            ...
            if (item != Items.field_151131_as && item != Items.bucket)
            {
                return false;
            }
        }
