...
public abstract class ChatComponentStyle implements IChatComponent
{
     ...
     */
    public IChatComponent func_150257_a(IChatComponent component)
    {
        component.func_150256_b().setParentStyle(this.func_150256_b());
     ...
     */
    public IChatComponent func_150258_a(String text)
    {
        return this.func_150257_a(new ChatComponentText(text));
    }
    ...
    public ChatStyle func_150256_b()
    {
        if (this.style == null)
        {
            ...
            for (IChatComponent ichatcomponent : this.siblings)
            {
                ichatcomponent.func_150256_b().setParentStyle(this.style);
            }
        }
    ...
    public final String getFormattedText()
    {
        ...
        for (IChatComponent ichatcomponent : this)
        {
            stringbuilder.append(ichatcomponent.func_150256_b().getFormattingCode());
            stringbuilder.append(ichatcomponent.getUnformattedTextForChat());
    ...
    public static Iterator<IChatComponent> createDeepCopyIterator(Iterable<IChatComponent> components)
    {
        ...
        iterator = Iterators.transform(iterator, new Function<IChatComponent, IChatComponent>()
        {
            public IChatComponent apply(IChatComponent p_apply_1_)
            {
                ...
                ichatcomponent.setChatStyle(ichatcomponent.func_150256_b().createDeepCopy());
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else
        {
            ...
            return this.siblings.equals(chatcomponentstyle.siblings) && this.func_150256_b().equals(chatcomponentstyle.func_150256_b());
        }
    }
