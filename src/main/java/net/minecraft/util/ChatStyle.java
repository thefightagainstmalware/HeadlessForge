...
public class ChatStyle
{
    ...
    private static final ChatStyle rootStyle = new ChatStyle()
    {
        ...
        public ChatStyle func_150238_a(EnumChatFormatting color)
        {
        ...
        public ChatStyle func_150217_b(Boolean italic)
        {
            throw new UnsupportedOperationException();
        }
        ...
        public ChatStyle func_150241_a(ClickEvent event)
        {
            throw new UnsupportedOperationException();
        }
    ...
    public ChatStyle createDeepCopy()
    {
        ...
        chatstyle.func_150217_b(Boolean.valueOf(this.getItalic()));
        ...
        chatstyle.func_150238_a(this.getColor());
        chatstyle.func_150241_a(this.getChatClickEvent());
