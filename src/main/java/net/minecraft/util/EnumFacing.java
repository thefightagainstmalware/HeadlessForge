...
public enum EnumFacing implements IStringSerializable
{
    ...
    {
        return getHorizontal(MathHelper.func_76128_c(angle / 90.0D + 0.5D) & 3);
    }
    ...
    public static EnumFacing getFacingFromVector(float p_176737_0_, float p_176737_1_, float p_176737_2_)
    {
        ...
        {
            float f1 = p_176737_0_ * (float)enumfacing1.directionVec.func_177958_n() + p_176737_1_ * (float)enumfacing1.directionVec.func_177956_o() + p_176737_2_ * (float)enumfacing1.directionVec.func_177952_p();
