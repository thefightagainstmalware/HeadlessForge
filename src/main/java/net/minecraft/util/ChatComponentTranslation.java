...
public class ChatComponentTranslation extends ChatComponentStyle
{
    ...
    public ChatComponentTranslation(String translationKey, Object... args)
    {
        ...
        for (Object object : args)
        {
            ...
            {
                ((IChatComponent)object).func_150256_b().setParentStyle(this.func_150256_b());
            }
        }
    }
        ...
        try
        {
            ...
            for (; matcher.find(j); j = l)
            {
                ...
                if (k > j)
                {
                    ...
                    chatcomponenttext.func_150256_b().setParentStyle(this.func_150256_b());
                ...
                if ("%".equals(s2) && "%%".equals(s))
                {
                    ...
                    chatcomponenttext2.func_150256_b().setParentStyle(this.func_150256_b());
            ...
            if (j < format.length())
            {
                ...
                chatcomponenttext1.func_150256_b().setParentStyle(this.func_150256_b());
    ...
    private IChatComponent getFormatArgumentAsComponent(int index)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ichatcomponent.func_150256_b().setParentStyle(this.func_150256_b());
            }
    ...
    public IChatComponent setChatStyle(ChatStyle style)
    {
        ...
        if (this.lastTranslationUpdateTimeInMilliseconds > -1L)
        {
            ...
            {
                ichatcomponent.func_150256_b().setParentStyle(style);
            }
        }
    ...
    public ChatComponentTranslation func_150259_f()
    {
        ...
        for (int i = 0; i < this.formatArgs.length; ++i)
        {
            ...
            {
                aobject[i] = ((IChatComponent)this.formatArgs[i]).func_150259_f();
            }
            else
            {
        ...
        chatcomponenttranslation.setChatStyle(this.func_150256_b().createShallowCopy());
    ...
    {
        return "TranslatableComponent{key=\'" + this.key + '\'' + ", args=" + Arrays.toString(this.formatArgs) + ", siblings=" + this.siblings + ", style=" + this.func_150256_b() + '}';
    }
