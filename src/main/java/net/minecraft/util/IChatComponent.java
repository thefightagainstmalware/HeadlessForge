...
public interface IChatComponent extends Iterable<IChatComponent>
{
     ...
     */
    IChatComponent func_150258_a(String text);

    /**
     * Appends the given component to the end of this one.
     */
    IChatComponent func_150257_a(IChatComponent component);
    ...
    public static class Serializer implements JsonDeserializer<IChatComponent>, JsonSerializer<IChatComponent>
    {
                    ...
                    if (jsonobject.has("with"))
                    {
                        ...
                        for (int i = 0; i < aobject.length; ++i)
                        {
                            ...
                            if (aobject[i] instanceof ChatComponentText)
                            {
                                ...
                                if (chatcomponenttext.func_150256_b().isEmpty() && chatcomponenttext.getSiblings().isEmpty())
                                {
        ...
        {
            if (p_serialize_1_ instanceof ChatComponentText && p_serialize_1_.func_150256_b().isEmpty() && p_serialize_1_.getSiblings().isEmpty())
            {
            ...
            else
            {
                ...
                if (!p_serialize_1_.func_150256_b().isEmpty())
                {
                    this.serializeChatStyle(p_serialize_1_.func_150256_b(), jsonobject, p_serialize_3_);
                }
