...
public class EnchantmentProtection extends Enchantment
{
    ...
    {
        int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.fireProtection.field_77352_x, p_92093_0_.getInventory());
    ...
    {
        int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchantment.blastProtection.field_77352_x, p_92092_0_.getInventory());
