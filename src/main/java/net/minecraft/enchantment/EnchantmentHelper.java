...
public class EnchantmentHelper
{
    ...
    public static Map<Integer, Integer> getEnchantments(ItemStack stack)
    {
        ...
        NBTTagList nbttaglist = stack.func_77973_b() == Items.field_151134_bR ? Items.field_151134_bR.getEnchantments(stack) : stack.func_77986_q();
    ...
    public static void setEnchantments(Map<Integer, Integer> enchMap, ItemStack stack)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (enchantment != null)
            {
                ...
                {
                    Items.field_151134_bR.addEnchantment(stack, new EnchantmentData(enchantment, ((Integer)enchMap.get(Integer.valueOf(i))).intValue()));
                }
            }
        }
        ...
        if (nbttaglist.func_74745_c() > 0)
        {
            if (stack.func_77973_b() != Items.field_151134_bR)
            {
                stack.func_77983_a("ench", nbttaglist);
            }
        }
        ...
        if (stack != null)
        {
            ...
            if (nbttaglist != null)
            {
                for (int i = 0; i < nbttaglist.func_74745_c(); ++i)
                {
                    ...
                    {
                        modifier.calculateModifier(Enchantment.func_180306_c(j), k);
                    }
                }
            }
        }
    ...
    {
        return getEnchantmentLevel(Enchantment.knockback.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.fireAspect.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getMaxEnchantmentLevel(Enchantment.respiration.field_77352_x, player.getInventory());
    }
    ...
    {
        return getMaxEnchantmentLevel(Enchantment.depthStrider.field_77352_x, player.getInventory());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.efficiency.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.silkTouch.field_77352_x, player.getHeldItem()) > 0;
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.fortune.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.luckOfTheSea.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.lure.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getEnchantmentLevel(Enchantment.looting.field_77352_x, player.getHeldItem());
    }
    ...
    {
        return getMaxEnchantmentLevel(Enchantment.aquaAffinity.field_77352_x, player.getInventory()) > 0;
    }
    ...
    public static ItemStack getEnchantedItem(Enchantment p_92099_0_, EntityLivingBase p_92099_1_)
    {
        ...
        {
            if (itemstack != null && getEnchantmentLevel(p_92099_0_.field_77352_x, itemstack) > 0)
            {
                return itemstack;
            }
        }
    ...
    public static ItemStack addRandomEnchantment(Random p_77504_0_, ItemStack p_77504_1_, int p_77504_2_)
    {
        ...
        if (flag)
        {
            p_77504_1_.setItem(Items.field_151134_bR);
        }
        ...
        if (list != null)
        {
            for (EnchantmentData enchantmentdata : list)
            {
                if (flag)
                {
                    Items.field_151134_bR.addEnchantment(p_77504_1_, enchantmentdata);
                }
                else
                {
                    p_77504_1_.func_77966_a(enchantmentdata.enchantmentobj, enchantmentdata.enchantmentLevel);
                }
            }
        }
                ...
                if (enchantmentdata != null)
                {
                    ...
                    for (int l = k; randomIn.nextInt(50) <= l; l >>= 1)
                    {
                        ...
                        while (iterator.hasNext())
                        {
                            ...
                            {
                                if (!enchantmentdata1.enchantmentobj.func_77326_a(Enchantment.func_180306_c(integer.intValue())))
                                {
                                    flag = false;
                                    break;
                                }
