...
public abstract class Enchantment
{
     ...
     */
    public static Enchantment func_180306_c(int enchID)
    {
     ...
     */
    public static Enchantment func_180305_b(String location)
    {
    ...
    {
        return this.type.canEnchantItem(stack.func_77973_b());
    }
