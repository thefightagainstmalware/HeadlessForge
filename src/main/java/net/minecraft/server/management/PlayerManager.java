...
public class PlayerManager
{
    ...
    public PlayerManager(WorldServer serverWorld)
    {
        ...
        this.setPlayerViewRadius(serverWorld.getMinecraftServer().func_71203_ab().getViewDistance());
    }
    ...
    {
        long i = this.theWorldServer.func_82737_E();
    ...
    public void markBlockForUpdate(BlockPos pos)
    {
        ...
        {
            playermanager$playerinstance.flagChunkForUpdate(pos.func_177958_n() & 15, pos.func_177956_o(), pos.func_177952_p() & 15);
        }
    }
    ...
    {
        int i = (int)player.field_70165_t >> 4;
        int j = (int)player.field_70161_v >> 4;
        player.managedPosX = player.field_70165_t;
        player.managedPosZ = player.field_70161_v;
    ...
    public void filterChunkLoadQueue(EntityPlayerMP player)
    {
        ...
        int k = (int)player.field_70165_t >> 4;
        int l = (int)player.field_70161_v >> 4;
        int i1 = 0;
        int j1 = 0;
    ...
    public void updateMountedMovingPlayer(EntityPlayerMP player)
    {
        int i = (int)player.field_70165_t >> 4;
        int j = (int)player.field_70161_v >> 4;
        double d0 = player.managedPosX - player.field_70165_t;
        double d1 = player.managedPosZ - player.field_70161_v;
    ...
    class PlayerInstance
    {
        ...
        public void addPlayer(EntityPlayerMP player)
        {
            ...
            else
            {
                ...
                {
                    this.previousWorldTime = PlayerManager.this.theWorldServer.func_82737_E();
                }
        ...
        public void removePlayer(EntityPlayerMP player)
        {
            if (this.playersWatchingChunk.contains(player))
            {
                ...
                {
                    player.field_71135_a.func_147359_a(new S21PacketChunkData(chunk, true, 0));
                }
        ...
        {
            theChunk.setInhabitedTime(theChunk.getInhabitedTime() + PlayerManager.this.theWorldServer.func_82737_E() - this.previousWorldTime);
            this.previousWorldTime = PlayerManager.this.theWorldServer.func_82737_E();
        }
        ...
        public void sendToAllPlayersWatchingChunk(Packet thePacket)
        {
            for (int i = 0; i < this.playersWatchingChunk.size(); ++i)
            {
                ...
                {
                    entityplayermp.field_71135_a.func_147359_a(thePacket);
                }
            }
        }
        ...
        public void onUpdate()
        {
            if (this.numBlocksToUpdate != 0)
            {
                if (this.numBlocksToUpdate == 1)
                {
                    ...
                    if (PlayerManager.this.theWorldServer.func_180495_p(blockpos).func_177230_c().func_149716_u())
                    {
                        this.sendTileToAllPlayersWatchingChunk(PlayerManager.this.theWorldServer.func_175625_s(blockpos));
                    }
                }
                ...
                else
                {
                    ...
                    for (int j1 = 0; j1 < this.numBlocksToUpdate; ++j1)
                    {
                        ...
                        if (PlayerManager.this.theWorldServer.func_180495_p(blockpos1).func_177230_c().func_149716_u())
                        {
                            this.sendTileToAllPlayersWatchingChunk(PlayerManager.this.theWorldServer.func_175625_s(blockpos1));
                        }
                    }
                }
