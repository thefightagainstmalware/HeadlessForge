...
public class NetHandlerLoginServer implements INetHandlerLoginServer, ITickable
{
    ...
    public void update()
    {
        ...
        {
            EntityPlayerMP entityplayermp = this.server.func_71203_ab().func_177451_a(this.loginGameProfile.getId());

            if (entityplayermp == null)
            {
                this.currentLoginState = NetHandlerLoginServer.LoginState.READY_TO_ACCEPT;
                this.server.func_71203_ab().initializeConnectionToPlayer(this.networkManager, this.field_181025_l);
    ...
    public void tryAcceptPlayer()
    {
        ...
        String s = this.server.func_71203_ab().allowUserToConnect(this.networkManager.getRemoteAddress(), this.loginGameProfile);
        ...
        else
        {
            ...
            if (entityplayermp != null)
            {
                ...
                this.field_181025_l = this.server.func_71203_ab().createPlayerForUser(this.loginGameProfile);
            }
            else
            {
                this.server.func_71203_ab().initializeConnectionToPlayer(this.networkManager, this.server.func_71203_ab().createPlayerForUser(this.loginGameProfile));
            }
        }
    }
    ...
    {
        logger.info(this.getConnectionInfo() + " lost connection: " + reason.func_150260_c());
    }
            ...
            (new Thread("User Authenticator #" + AUTHENTICATOR_THREAD_ID.incrementAndGet())
            {
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        else if (NetHandlerLoginServer.this.server.func_71264_H())
                        {
                    ...
                    {
                        if (NetHandlerLoginServer.this.server.func_71264_H())
                        {
