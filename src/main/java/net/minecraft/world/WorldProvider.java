...
public abstract class WorldProvider
{
    ...
    public final void registerWorld(World worldIn)
    {
        ...
        this.terrainType = worldIn.func_72912_H().getTerrainType();
        this.generatorSettings = worldIn.func_72912_H().getGeneratorOptions();
    ...
    {
        WorldType worldtype = this.worldObj.func_72912_H().getTerrainType();

        if (worldtype == WorldType.FLAT)
        {
            FlatGeneratorInfo flatgeneratorinfo = FlatGeneratorInfo.createFlatGeneratorFromString(this.worldObj.func_72912_H().getGeneratorOptions());
    ...
    {
        return (IChunkProvider)(this.terrainType == WorldType.FLAT ? new ChunkProviderFlat(this.worldObj, this.worldObj.func_72905_C(), this.worldObj.func_72912_H().isMapFeaturesEnabled(), this.generatorSettings) : (this.terrainType == WorldType.DEBUG_WORLD ? new ChunkProviderDebug(this.worldObj) : (this.terrainType == WorldType.CUSTOMIZED ? new ChunkProviderGenerate(this.worldObj, this.worldObj.func_72905_C(), this.worldObj.func_72912_H().isMapFeaturesEnabled(), this.generatorSettings) : new ChunkProviderGenerate(this.worldObj, this.worldObj.func_72905_C(), this.worldObj.func_72912_H().isMapFeaturesEnabled(), this.generatorSettings))));
    }
    ...
    {
        return this.worldObj.getGroundAboveSeaLevel(new BlockPos(x, 0, z)) == Blocks.field_150349_c;
    }
