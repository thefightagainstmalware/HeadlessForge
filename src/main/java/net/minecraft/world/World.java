...
public abstract class World implements IBlockAccess
{
    ...
    public Block getGroundAboveSeaLevel(BlockPos pos)
    {
        ...
        for (blockpos = new BlockPos(pos.func_177958_n(), this.func_181545_F(), pos.func_177952_p()); !this.func_175623_d(blockpos.up()); blockpos = blockpos.up())
        {
            ;
        }
    ...
    {
        return this.func_180495_p(pos).func_177230_c().func_149688_o() == Material.field_151579_a;
    }

    public boolean func_175667_e(BlockPos pos)
    {
        return this.func_175667_e(pos, true);
    }

    public boolean func_175667_e(BlockPos pos, boolean allowEmpty)
    {
        return !this.isValid(pos) ? false : this.isChunkLoaded(pos.func_177958_n() >> 4, pos.func_177952_p() >> 4, allowEmpty);
    }
    ...
    {
        return this.isAreaLoaded(center.func_177958_n() - radius, center.func_177956_o() - radius, center.func_177952_p() - radius, center.func_177958_n() + radius, center.func_177956_o() + radius, center.func_177952_p() + radius, allowEmpty);
    }
    ...
    {
        return this.isAreaLoaded(from.func_177958_n(), from.func_177956_o(), from.func_177952_p(), to.func_177958_n(), to.func_177956_o(), to.func_177952_p(), allowEmpty);
    }
    ...
    {
        return this.isAreaLoaded(box.field_78897_a, box.field_78895_b, box.field_78896_c, box.field_78893_d, box.field_78894_e, box.field_78892_f, allowEmpty);
    }
    ...
    {
        return this.getChunkFromChunkCoords(pos.func_177958_n() >> 4, pos.func_177952_p() >> 4);
    }
    ...
    public boolean func_180501_a(BlockPos pos, IBlockState newState, int flags)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    this.func_175722_b(pos, iblockstate.func_177230_c());
    ...
    public boolean func_175655_b(BlockPos pos, boolean dropBlock)
    {
        ...
        {
            this.playAuxSFX(2001, pos, Block.func_176210_f(iblockstate));
    ...
    public void func_175689_h(BlockPos pos)
    {
    ...
    {
        this.markBlockRangeForRenderUpdate(rangeMin.func_177958_n(), rangeMin.func_177956_o(), rangeMin.func_177952_p(), rangeMax.func_177958_n(), rangeMax.func_177956_o(), rangeMax.func_177952_p());
    }
    ...
    public void notifyNeighborsOfStateChange(BlockPos pos, Block blockType)
    {
        ...
        this.notifyBlockOfStateChange(pos.func_177977_b(), blockType);
    ...
    public void notifyBlockOfStateChange(BlockPos pos, final Block blockIn)
    {
        if (!this.isRemote)
        {
            ...
            try
            {
                iblockstate.func_177230_c().onNeighborBlockChange(this, pos, iblockstate, blockIn);
            }
            catch (Throwable throwable)
            {
                ...
                crashreportcategory.addCrashSectionCallable("Source block type", new Callable<String>()
                {
                    public String call() throws Exception
                    {
                        try
                        {
                            return String.format("ID #%d (%s // %s)", new Object[] {Integer.valueOf(Block.func_149682_b(blockIn)), blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName()});
                        }
    ...
    public boolean canBlockSeeSky(BlockPos pos)
    {
        ...
        else
        {
            ...
            {
                for (blockpos = blockpos.func_177977_b(); blockpos.func_177956_o() > pos.func_177956_o(); blockpos = blockpos.func_177977_b())
                {
                    Block block = this.func_180495_p(blockpos).func_177230_c();

                    if (block.getLightOpacity() > 0 && !block.func_149688_o().func_76224_d())
                    {
                        return false;
                    }
                }
    ...
    public int getLight(BlockPos pos, boolean checkNeighbors)
    {
        ...
        {
            if (checkNeighbors && this.func_180495_p(pos).func_177230_c().getUseNeighborBrightness())
            {
    ...
    public BlockPos getHeight(BlockPos pos)
    {
        ...
        if (pos.func_177958_n() >= -30000000 && pos.func_177952_p() >= -30000000 && pos.func_177958_n() < 30000000 && pos.func_177952_p() < 30000000)
        {
            if (this.isChunkLoaded(pos.func_177958_n() >> 4, pos.func_177952_p() >> 4, true))
            {
                i = this.getChunkFromChunkCoords(pos.func_177958_n() >> 4, pos.func_177952_p() >> 4).getHeightValue(pos.func_177958_n() & 15, pos.func_177952_p() & 15);
            }
            else
            {
                i = 0;
        ...
        return new BlockPos(pos.func_177958_n(), i, pos.func_177952_p());
    }
    ...
    public int getLightFromNeighborsFor(EnumSkyBlock type, BlockPos pos)
    {
        ...
        else
        {
            ...
            else if (this.func_180495_p(pos).func_177230_c().getUseNeighborBrightness())
            {
    ...
    public void func_72956_a(Entity entityIn, String name, float volume, float pitch)
    {
        for (int i = 0; i < this.worldAccesses.size(); ++i)
        {
            ((IWorldAccess)this.worldAccesses.get(i)).playSound(name, entityIn.field_70165_t, entityIn.field_70163_u, entityIn.field_70161_v, volume, pitch);
        }
    }
    ...
    public void playSoundToNearExcept(EntityPlayer player, String name, float volume, float pitch)
    {
        for (int i = 0; i < this.worldAccesses.size(); ++i)
        {
            ((IWorldAccess)this.worldAccesses.get(i)).playSoundToNearExcept(player, name, player.field_70165_t, player.field_70163_u, player.field_70161_v, volume, pitch);
        }
    }
    ...
    public void removeEntity(Entity entityIn)
    {
        ...
        {
            entityIn.riddenByEntity.func_70078_a((Entity)null);
        }

        if (entityIn.ridingEntity != null)
        {
            entityIn.func_70078_a((Entity)null);
        }
    ...
    public List<AxisAlignedBB> getCollidingBoundingBoxes(Entity entityIn, AxisAlignedBB bb)
    {
        ...
        int i = MathHelper.func_76128_c(bb.minX);
        int j = MathHelper.func_76128_c(bb.maxX + 1.0D);
        int k = MathHelper.func_76128_c(bb.minY);
        int l = MathHelper.func_76128_c(bb.maxY + 1.0D);
        int i1 = MathHelper.func_76128_c(bb.minZ);
        int j1 = MathHelper.func_76128_c(bb.maxZ + 1.0D);
            ...
            for (int l1 = i1; l1 < j1; ++l1)
            {
                if (this.func_175667_e(blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
                {
                    for (int i2 = k - 1; i2 < l; ++i2)
                    {
                        ...
                        iblockstate1.func_177230_c().addCollisionBoxesToList(this, blockpos$mutableblockpos, iblockstate1, bb, list, entityIn);
                    }
                }
            }
        }
    ...
    public boolean isInsideBorder(WorldBorder worldBorderIn, Entity entityIn)
    {
        ...
        return entityIn.field_70165_t > d0 && entityIn.field_70165_t < d2 && entityIn.field_70161_v > d1 && entityIn.field_70161_v < d3;
    }
            ...
            for (int l1 = i1; l1 < j1; ++l1)
            {
                if (this.func_175667_e(blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
                {
                    for (int i2 = k - 1; i2 < l; ++i2)
                    {
                        ...
                        iblockstate.func_177230_c().addCollisionBoxesToList(this, blockpos$mutableblockpos, iblockstate, bb, list, (Entity)null);
                    }
                }
            }
        }
    ...
    public BlockPos getTopSolidOrLiquidBlock(BlockPos pos)
    {
        ...
        for (blockpos = new BlockPos(pos.func_177958_n(), chunk.getTopFilledSegment() + 16, pos.func_177952_p()); blockpos.func_177956_o() >= 0; blockpos = blockpos1)
        {
            blockpos1 = blockpos.func_177977_b();
            Material material = chunk.getBlock(blockpos1).func_149688_o();
    ...
    public void updateEntities()
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (!tileentity.isInvalid() && tileentity.hasWorldObj())
            {
                ...
                if (this.func_175667_e(blockpos) && this.worldBorder.contains(blockpos))
                {
                    try
                    {
            ...
            if (tileentity.isInvalid())
            {
                ...
                if (this.func_175667_e(tileentity.getPos()))
                {
    ...
    public void updateEntityWithOptionalForce(Entity entityIn, boolean forceUpdate)
    {
        ...
        {
            entityIn.lastTickPosX = entityIn.field_70165_t;
            entityIn.lastTickPosY = entityIn.field_70163_u;
            entityIn.lastTickPosZ = entityIn.field_70161_v;
            entityIn.prevRotationYaw = entityIn.field_70177_z;
            entityIn.prevRotationPitch = entityIn.field_70125_A;
            ...
            {
                entityIn.field_70165_t = entityIn.lastTickPosX;
            }

            if (Double.isNaN(entityIn.field_70163_u) || Double.isInfinite(entityIn.field_70163_u))
            {
                entityIn.field_70163_u = entityIn.lastTickPosY;
            }

            if (Double.isNaN(entityIn.field_70161_v) || Double.isInfinite(entityIn.field_70161_v))
            {
                entityIn.field_70161_v = entityIn.lastTickPosZ;
            }

            if (Double.isNaN((double)entityIn.field_70125_A) || Double.isInfinite((double)entityIn.field_70125_A))
            {
                entityIn.field_70125_A = entityIn.prevRotationPitch;
            }

            if (Double.isNaN((double)entityIn.field_70177_z) || Double.isInfinite((double)entityIn.field_70177_z))
            {
                entityIn.field_70177_z = entityIn.prevRotationYaw;
            }

            int l = MathHelper.func_76128_c(entityIn.field_70165_t / 16.0D);
            int i1 = MathHelper.func_76128_c(entityIn.field_70163_u / 16.0D);
            int j1 = MathHelper.func_76128_c(entityIn.field_70161_v / 16.0D);
    ...
    {
        int i = MathHelper.func_76128_c(bb.minX);
        int j = MathHelper.func_76128_c(bb.maxX);
        int k = MathHelper.func_76128_c(bb.minY);
        int l = MathHelper.func_76128_c(bb.maxY);
        int i1 = MathHelper.func_76128_c(bb.minZ);
        int j1 = MathHelper.func_76128_c(bb.maxZ);
        BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos();
    ...
    public boolean handleMaterialAcceleration(AxisAlignedBB bb, Material materialIn, Entity entityIn)
    {
        ...
        else
        {
            ...
            if (vec3.lengthVector() > 0.0D && entityIn.isPushedByWater())
            {
                vec3 = vec3.normalize();
                double d1 = 0.014D;
                entityIn.motionX += vec3.field_72450_a * d1;
                entityIn.motionY += vec3.field_72448_b * d1;
                entityIn.motionZ += vec3.field_72449_c * d1;
            }
    ...
    public boolean isMaterialInBB(AxisAlignedBB bb, Material materialIn)
    {
        ...
        for (int k1 = i; k1 < j; ++k1)
        {
            for (int l1 = k; l1 < l; ++l1)
            {
                for (int i2 = i1; i2 < j1; ++i2)
                {
                    if (this.func_180495_p(blockpos$mutableblockpos.func_181079_c(k1, l1, i2)).func_177230_c().func_149688_o() == materialIn)
                    {
                        return true;
                    }
                }
    ...
    public boolean extinguishFire(EntityPlayer player, BlockPos pos, EnumFacing side)
    {
        ...
        if (this.func_180495_p(pos).func_177230_c() == Blocks.fire)
        {
    ...
    {
        IBlockState iblockstate = this.func_180495_p(pos);
        AxisAlignedBB axisalignedbb = iblockstate.func_177230_c().getCollisionBoundingBox(this, pos, iblockstate);
    ...
    public boolean isBlockNormalCube(BlockPos pos, boolean _default)
    {
        ...
        else
        {
            ...
            {
                Block block = this.func_180495_p(pos).func_177230_c();
                return block.func_149688_o().isOpaque() && block.func_149686_d();
            }
        }
    }
    ...
    protected void updateWeather()
    {
        if (!this.provider.getHasNoSky())
        {
            if (!this.isRemote)
            {
                ...
                {
                    --i;
                    this.worldInfo.func_176142_i(i);
                    this.worldInfo.func_76090_f(this.worldInfo.isThundering() ? 1 : 2);
                    this.worldInfo.func_76080_g(this.worldInfo.func_76059_o() ? 1 : 2);
                }
                ...
                if (j <= 0)
                {
                    if (this.worldInfo.isThundering())
                    {
                        this.worldInfo.func_76090_f(this.rand.nextInt(12000) + 3600);
                    }
                    else
                    {
                        this.worldInfo.func_76090_f(this.rand.nextInt(168000) + 12000);
                    }
                }
                else
                {
                    --j;
                    this.worldInfo.func_76090_f(j);

                    if (j <= 0)
                    {
                        this.worldInfo.func_76069_a(!this.worldInfo.isThundering());
                    }
                }
                ...
                this.thunderingStrength = MathHelper.func_76131_a(this.thunderingStrength, 0.0F, 1.0F);
                ...
                if (k <= 0)
                {
                    if (this.worldInfo.func_76059_o())
                    {
                        this.worldInfo.func_76080_g(this.rand.nextInt(12000) + 12000);
                    }
                    else
                    {
                        this.worldInfo.func_76080_g(this.rand.nextInt(168000) + 12000);
                    }
                }
                else
                {
                    --k;
                    this.worldInfo.func_76080_g(k);

                    if (k <= 0)
                    {
                        this.worldInfo.func_76084_b(!this.worldInfo.func_76059_o());
                    }
                }
                ...
                this.rainingStrength = MathHelper.func_76131_a(this.rainingStrength, 0.0F, 1.0F);
            }
        }
    }
    ...
    protected void setActivePlayerChunksAndCheckLight()
    {
        ...
        if (!this.playerEntities.isEmpty())
        {
            ...
            int l1 = MathHelper.func_76128_c(entityplayer1.field_70165_t) + this.rand.nextInt(11) - 5;
            int i2 = MathHelper.func_76128_c(entityplayer1.field_70163_u) + this.rand.nextInt(11) - 5;
            int j2 = MathHelper.func_76128_c(entityplayer1.field_70161_v) + this.rand.nextInt(11) - 5;
    ...
    protected void playMoodSoundAndCheckLight(int p_147467_1_, int p_147467_2_, Chunk chunkIn)
    {
        ...
        if (this.ambientTickCountdown == 0 && !this.isRemote)
        {
            ...
            if (block.func_149688_o() == Material.field_151579_a && this.getLight(blockpos) <= this.rand.nextInt(8) && this.getLightFor(EnumSkyBlock.SKY, blockpos) <= 0)
            {
    ...
    public void forceBlockUpdateTick(Block blockType, BlockPos pos, Random random)
    {
        ...
        blockType.updateTick(this, pos, this.func_180495_p(pos), random);
    ...
    public boolean canBlockFreeze(BlockPos pos, boolean noWaterAdj)
    {
        ...
        {
            if (pos.func_177956_o() >= 0 && pos.func_177956_o() < 256 && this.getLightFor(EnumSkyBlock.BLOCK, pos) < 10)
            {
                IBlockState iblockstate = this.func_180495_p(pos);
                Block block = iblockstate.func_177230_c();

                if ((block == Blocks.field_150355_j || block == Blocks.field_150358_i) && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0)
                {
                    if (!noWaterAdj)
                    {
                        return true;
    ...
    {
        return this.func_180495_p(pos).func_177230_c().func_149688_o() == Material.water;
    }
    ...
    public boolean canSnowAt(BlockPos pos, boolean checkLight)
    {
        ...
        else
        {
            if (pos.func_177956_o() >= 0 && pos.func_177956_o() < 256 && this.getLightFor(EnumSkyBlock.BLOCK, pos) < 10)
            {
                ...
                if (block.func_149688_o() == Material.field_151579_a && Blocks.snow_layer.canPlaceBlockAt(this, pos))
                {
                    return true;
                }
            }
                        ...
                        if (l2 > 0)
                        {
                            ...
                            if (j3 + k3 + l3 < 17)
                            {
                                ...
                                for (EnumFacing enumfacing : EnumFacing.values())
                                {
                                    ...
                                    int l4 = Math.max(1, this.func_180495_p(blockpos$mutableblockpos).func_177230_c().getLightOpacity());
                ...
                if (j6 != i6)
                {
                    ...
                    if (j6 > i6)
                    {
                        ...
                        if (k6 + l6 + i7 < 17 && flag)
                        {
                            ...
                            if (this.getLightFor(lightType, blockpos1.func_177977_b()) < j6)
                            {
    ...
    public List<Entity> getEntitiesInAABBexcluding(Entity entityIn, AxisAlignedBB boundingBox, Predicate <? super Entity > predicate)
    {
        ...
        int i = MathHelper.func_76128_c((boundingBox.minX - 2.0D) / 16.0D);
        int j = MathHelper.func_76128_c((boundingBox.maxX + 2.0D) / 16.0D);
        int k = MathHelper.func_76128_c((boundingBox.minZ - 2.0D) / 16.0D);
        int l = MathHelper.func_76128_c((boundingBox.maxZ + 2.0D) / 16.0D);
    ...
    {
        int i = MathHelper.func_76128_c((aabb.minX - 2.0D) / 16.0D);
        int j = MathHelper.func_76128_c((aabb.maxX + 2.0D) / 16.0D);
        int k = MathHelper.func_76128_c((aabb.minZ - 2.0D) / 16.0D);
        int l = MathHelper.func_76128_c((aabb.maxZ + 2.0D) / 16.0D);
        List<T> list = Lists.<T>newArrayList();
    ...
    {
        Block block = this.func_180495_p(pos).func_177230_c();
        AxisAlignedBB axisalignedbb = p_175716_3_ ? null : blockIn.getCollisionBoundingBox(this, pos, blockIn.func_176223_P());
        return axisalignedbb != null && !this.checkNoEntityCollision(axisalignedbb, entityIn) ? false : (block.func_149688_o() == Material.circuits && blockIn == Blocks.field_150467_bQ ? true : block.func_149688_o().isReplaceable() && blockIn.canReplace(this, pos, side, itemStackIn));
    }
    ...
    {
        IBlockState iblockstate = this.func_180495_p(pos);
        return iblockstate.func_177230_c().getStrongPower(this, pos, iblockstate, direction);
    }
    ...
    {
        int i = 0;
        i = Math.max(i, this.getStrongPower(pos.func_177977_b(), EnumFacing.DOWN));
    ...
    {
        return this.getClosestPlayer(entityIn.field_70165_t, entityIn.field_70163_u, entityIn.field_70161_v, distance);
    }
    ...
    {
        this.worldInfo.func_72877_b(time);
    }
    ...
    public BlockPos getSpawnPoint()
    {
        ...
        if (!this.func_175723_af().contains(blockpos))
        {
            blockpos = this.getHeight(new BlockPos(this.func_175723_af().getCenterX(), 0.0D, this.func_175723_af().getCenterZ()));
        }
    ...
    {
        blockIn.onBlockEventReceived(this, pos, this.func_180495_p(pos), eventID, eventParam);
    }
    ...
    public boolean canLightningStrike(BlockPos strikePosition)
    {
        ...
        else if (this.getPrecipitationHeight(strikePosition).func_177956_o() > strikePosition.func_177956_o())
        {
            return false;
        }
        else
    ...
    {
        long i = (long)p_72843_1_ * 341873128712L + (long)p_72843_2_ * 132897987541L + this.func_72912_H().getSeed() + (long)p_72843_3_;
        this.rand.setSeed(i);
        return this.rand;
    }
    ...
    public void updateComparatorOutputLevel(BlockPos pos, Block blockIn)
    {
        for (Object enumfacing : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            if (this.func_175667_e(blockpos))
            {
                ...
                if (Blocks.field_150441_bU.isAssociated(iblockstate.func_177230_c()))
                {
                    iblockstate.func_177230_c().onNeighborBlockChange(this, blockpos, iblockstate, blockIn);
                }
                else if (iblockstate.func_177230_c().isNormalCube())
                {
    ...
    public DifficultyInstance func_175649_E(BlockPos pos)
    {
        ...
        return new DifficultyInstance(this.getDifficulty(), this.func_72820_D(), i, f);
    }

    public EnumDifficulty getDifficulty()
    {
        return this.func_72912_H().getDifficulty();
    }
