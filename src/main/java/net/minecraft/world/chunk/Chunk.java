...
public class Chunk
{
    ...
    {
        return this.getHeightValue(pos.func_177958_n() & 15, pos.func_177952_p() & 15);
    }
    ...
    {
        int i = this.worldObj.getHeight(new BlockPos(x, 0, z)).func_177956_o();
    ...
    public Block getBlock(final BlockPos pos)
    {
        try
        {
            return this.getBlock0(pos.func_177958_n() & 15, pos.func_177956_o(), pos.func_177952_p() & 15);
        }
        catch (ReportedException reportedexception)
        {
            CrashReportCategory crashreportcategory = reportedexception.getCrashReport().makeCategory("Block being got");
    ...
    public IBlockState getBlockState(final BlockPos pos)
    {
        if (this.worldObj.getWorldType() == WorldType.DEBUG_WORLD)
        {
            ...
            {
                iblockstate = ChunkProviderDebug.func_177461_b(pos.func_177958_n(), pos.func_177952_p());
            }
        ...
        else
        {
            try
            {
                if (pos.func_177956_o() >= 0 && pos.func_177956_o() >> 4 < this.storageArrays.length)
                {
                    ExtendedBlockStorage extendedblockstorage = this.storageArrays[pos.func_177956_o() >> 4];

                    if (extendedblockstorage != null)
                    {
                        int j = pos.func_177958_n() & 15;
                        int k = pos.func_177956_o() & 15;
                        int i = pos.func_177952_p() & 15;
    ...
    {
        return this.getBlockMetadata(pos.func_177958_n() & 15, pos.func_177956_o(), pos.func_177952_p() & 15);
    }
        ...
        else
        {
            ...
            else
            {
                ...
                if (block instanceof ITileEntityProvider)
                {
                    ...
                    if (tileentity1 == null)
                    {
                        tileentity1 = ((ITileEntityProvider)block).createNewTileEntity(this.worldObj, block.func_176201_c(state));
    ...
    public void addEntity(Entity entityIn)
    {
        ...
        int k = MathHelper.func_76128_c(entityIn.field_70163_u / 16.0D);
    ...
    private TileEntity createNewTileEntity(BlockPos pos)
    {
        ...
        return !block.func_149716_u() ? null : ((ITileEntityProvider)block).createNewTileEntity(this.worldObj, this.getBlockMetadata(pos));
    }
    ...
    {
        int i = MathHelper.func_76128_c((aabb.minY - 2.0D) / 16.0D);
        int j = MathHelper.func_76128_c((aabb.maxY + 2.0D) / 16.0D);
    ...
    public boolean needsSaving(boolean p_76601_1_)
    {
        if (p_76601_1_)
        {
            if (this.hasEntities && this.worldObj.func_82737_E() != this.lastSaveTime || this.isModified)
            {
                return true;
            }
        }
    ...
    {
        return new Random(this.worldObj.func_72905_C() + (long)(this.xPosition * this.xPosition * 4987142) + (long)(this.xPosition * 5947611) + (long)(this.zPosition * this.zPosition) * 4392871L + (long)(this.zPosition * 389711) ^ seed);
    }
    ...
    {
        int i = pos.func_177958_n() & 15;
        int j = pos.func_177952_p() & 15;
        int k = i | j << 4;
        BlockPos blockpos = new BlockPos(pos.func_177958_n(), this.precipitationHeightMap[k], pos.func_177952_p());

        if (blockpos.func_177956_o() == -999)
        {
            int l = this.getTopFilledSegment() + 15;
            blockpos = new BlockPos(pos.func_177958_n(), l, pos.func_177952_p());
            int i1 = -1;
        ...
        return new BlockPos(pos.func_177958_n(), this.precipitationHeightMap[k], pos.func_177952_p());
    }
    ...
    public void func_150804_b(boolean p_150804_1_)
    {
        ...
        while (!this.tileEntityPosQueue.isEmpty())
        {
            ...
            if (this.getTileEntity(blockpos, Chunk.EnumCreateEntityType.CHECK) == null && this.getBlock(blockpos).func_149716_u())
            {
    ...
    public void enqueueRelightChecks()
    {
        ...
        for (int i = 0; i < 8; ++i)
        {
            ...
            for (int i1 = 0; i1 < 16; ++i1)
            {
                ...
                if (this.storageArrays[j] == null && flag || this.storageArrays[j] != null && this.storageArrays[j].getBlockByExtId(k, i1, l).func_149688_o() == Material.field_151579_a)
                {
                    for (EnumFacing enumfacing : EnumFacing.values())
                    {
                        BlockPos blockpos2 = blockpos1.offset(enumfacing);

                        if (this.worldObj.func_180495_p(blockpos2).func_177230_c().getLightValue() > 0)
                        {
    ...
    private boolean func_150811_f(int x, int z)
    {
        ...
        for (int j = i + 16 - 1; j > this.worldObj.func_181545_F() || j > 0 && !flag1; --j)
        {
            ...
            if (k == 255 && blockpos$mutableblockpos.func_177956_o() < this.worldObj.func_181545_F())
            {
                flag1 = true;
            }
