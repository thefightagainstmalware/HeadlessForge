...
public class EmptyChunk extends Chunk
{
    ...
    {
        return new Random(this.getWorld().func_72905_C() + (long)(this.xPosition * this.xPosition * 4987142) + (long)(this.xPosition * 5947611) + (long)(this.zPosition * this.zPosition) * 4392871L + (long)(this.zPosition * 389711) ^ seed);
    }
