...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public void writePlayerData(EntityPlayer player)
    {
        try
        {
            ...
            player.func_70109_d(nbttagcompound);
            File file1 = new File(this.playersDirectory, player.func_110124_au().toString() + ".dat.tmp");
            File file2 = new File(this.playersDirectory, player.func_110124_au().toString() + ".dat");
        ...
        {
            logger.warn("Failed to save player data for " + player.func_70005_c_());
        }
    }
    ...
    public NBTTagCompound readPlayerData(EntityPlayer player)
    {
        ...
        try
        {
            File file1 = new File(this.playersDirectory, player.func_110124_au().toString() + ".dat");
        ...
        {
            logger.warn("Failed to load player data for " + player.func_70005_c_());
        }

        if (nbttagcompound != null)
        {
            player.func_70020_e(nbttagcompound);
        }
