...
public abstract class BiomeGenBase
{
    ...
    public final float getFloatTemperature(BlockPos pos)
    {
        ...
        {
            float f = (float)(temperatureNoise.func_151601_a((double)pos.func_177958_n() * 1.0D / 8.0D, (double)pos.func_177952_p() * 1.0D / 8.0D) * 4.0D);
            return this.temperature - (f + (float)pos.func_177956_o() - 64.0F) * 0.05F / 30.0F;
        }
        else
        {
    ...
    {
        double d0 = (double)MathHelper.func_76131_a(this.getFloatTemperature(pos), 0.0F, 1.0F);
        double d1 = (double)MathHelper.func_76131_a(this.getFloatRainfall(), 0.0F, 1.0F);
    ...
    public final void generateBiomeTerrain(World worldIn, Random rand, ChunkPrimer chunkPrimerIn, int p_180628_4_, int p_180628_5_, double p_180628_6_)
    {
        ...
        for (int j1 = 255; j1 >= 0; --j1)
        {
            ...
            {
                chunkPrimerIn.setBlockState(i1, j1, l, Blocks.field_150357_h.func_176223_P());
            }
            else
            {
                ...
                else if (iblockstate2.func_177230_c() == Blocks.field_150348_b)
                {
                    if (j == -1)
                    {
                        ...
                        if (j1 < i && (iblockstate == null || iblockstate.func_177230_c().func_149688_o() == Material.field_151579_a))
                        {
                            ...
                            {
                                iblockstate = Blocks.ice.func_176223_P();
                            }
                            else
                            {
                        ...
                        else if (j1 < i - 7 - k)
                        {
                            iblockstate = null;
                            iblockstate1 = Blocks.field_150348_b.func_176223_P();
                            chunkPrimerIn.setBlockState(i1, j1, l, Blocks.field_150351_n.func_176223_P());
                        }
                        else
                        {
                    ...
                    else if (j > 0)
                    {
                        ...
                        if (j == 0 && iblockstate1.func_177230_c() == Blocks.sand)
                        {
                            j = rand.nextInt(4) + Math.max(0, j1 - 63);
                            iblockstate1 = iblockstate1.getValue(BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND ? Blocks.red_sandstone.func_176223_P() : Blocks.sandstone.func_176223_P();
                        }
                    }
                }
            }
