...
public class BiomeGenMesa extends BiomeGenBase
{
    ...
    public BiomeGenMesa(int p_i45380_1_, boolean p_i45380_2_, boolean p_i45380_3_)
    {
        ...
        this.topBlock = Blocks.sand.func_176223_P().withProperty(BlockSand.VARIANT, BlockSand.EnumType.RED_SAND);
        this.fillerBlock = Blocks.field_150406_ce.func_176223_P();
    ...
    {
        if (this.field_150621_aC == null || this.field_150622_aD != worldIn.func_72905_C())
        {
            this.func_150619_a(worldIn.func_72905_C());
        }

        if (this.field_150623_aE == null || this.field_150624_aF == null || this.field_150622_aD != worldIn.func_72905_C())
        {
        ...
        this.field_150622_aD = worldIn.func_72905_C();
        double d4 = 0.0D;
        ...
        {
            if (chunkPrimerIn.getBlockState(k1, i1, j1).func_177230_c().func_149688_o() == Material.field_151579_a && i1 < (int)d4)
            {
                chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.field_150348_b.func_176223_P());
            }

            if (i1 <= rand.nextInt(5))
            {
                chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.field_150357_h.func_176223_P());
            }
            else
            {
                ...
                else if (iblockstate1.func_177230_c() == Blocks.field_150348_b)
                {
                    if (l == -1)
                    {
                        ...
                        if (i1 < l1 - 1)
                        {
                            ...
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, iblockstate3.func_177230_c().func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE));
                            }
                        }
                        else if (this.field_150620_aI && i1 > 86 + k * 2)
                        {
                            if (flag)
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.field_150346_d.func_176223_P().withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.COARSE_DIRT));
                            }
                            else
                            {
                                chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.field_150349_c.func_176223_P());
                            }
                        }
                        else if (i1 <= l1 + 3 + k)
                        {
                        ...
                        else
                        {
                            ...
                            if (i1 >= 64 && i1 <= 127)
                            {
                                if (flag)
                                {
                                    iblockstate4 = Blocks.hardened_clay.func_176223_P();
                                }
                                else
                                {
                            ...
                            {
                                iblockstate4 = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
                            }
                    ...
                    else if (l > 0)
                    {
                        ...
                        if (flag1)
                        {
                            chunkPrimerIn.setBlockState(k1, i1, j1, Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE));
                        }
                        else
                        {
    ...
    private void func_150619_a(long p_150619_1_)
    {
        ...
        Arrays.fill(this.field_150621_aC, Blocks.hardened_clay.func_176223_P());
        ...
        for (int l1 = 0; l1 < 64; ++l1)
        {
            ...
            if (l1 < 64)
            {
                this.field_150621_aC[l1] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
            }
        }
        ...
        for (int i = 0; i < i2; ++i)
        {
            ...
            {
                this.field_150621_aC[k + l] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
            }
        }
        ...
        for (int k2 = 0; k2 < j2; ++k2)
        {
            ...
            {
                this.field_150621_aC[l3 + i1] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.BROWN);
            }
        }
        ...
        for (int j3 = 0; j3 < l2; ++j3)
        {
            ...
            {
                this.field_150621_aC[k4 + j1] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.RED);
            }
        }
        ...
        for (int l4 = 0; l4 < k3; ++l4)
        {
            ...
            {
                this.field_150621_aC[j4 + k1] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);

                if (j4 + k1 > 1 && random.nextBoolean())
                {
                    this.field_150621_aC[j4 + k1 - 1] = Blocks.field_150406_ce.func_176223_P().withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
                }
