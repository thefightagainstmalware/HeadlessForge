...
public class BiomeGenPlains extends BiomeGenBase
{
    ...
    {
        double d0 = GRASS_COLOR_NOISE.func_151601_a((double)pos.func_177958_n() / 200.0D, (double)pos.func_177952_p() / 200.0D);
    ...
    {
        double d0 = GRASS_COLOR_NOISE.func_151601_a((double)(pos.func_177958_n() + 8) / 200.0D, (double)(pos.func_177952_p() + 8) / 200.0D);
        ...
        else
        {
            ...
            for (int i = 0; i < 7; ++i)
            {
                ...
                int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).func_177956_o() + 32);
        ...
        if (this.field_150628_aC)
        {
            ...
            for (int i1 = 0; i1 < 10; ++i1)
            {
                ...
                int l1 = rand.nextInt(worldIn.getHeight(pos.add(j1, 0, k1)).func_177956_o() + 32);
