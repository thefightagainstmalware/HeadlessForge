...
public class ChunkProviderGenerate implements IChunkProvider
{
    ...
    public ChunkProviderGenerate(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
        ...
        this.field_177475_o = worldIn.func_72912_H().getTerrainType();
        ...
        if (p_i45636_5_ != null)
        {
            ...
            this.field_177476_s = this.settings.useLavaOceans ? Blocks.lava : Blocks.field_150355_j;
                    ...
                    for (int j2 = 0; j2 < 8; ++j2)
                    {
                        ...
                        for (int k2 = 0; k2 < 4; ++k2)
                        {
                            ...
                            for (int l2 = 0; l2 < 4; ++l2)
                            {
                                ...
                                {
                                    p_180518_3_.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, Blocks.field_150348_b.func_176223_P());
                                }
                                else if (i2 * 8 + j2 < this.settings.seaLevel)
                                {
                                    p_180518_3_.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, this.field_177476_s.func_176223_P());
                                }
                            }
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
        ...
        this.rand.setSeed((long)p_73153_2_ * k + (long)p_73153_3_ * l ^ this.worldObj.func_72905_C());
        boolean flag = false;
        ...
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0)
        {
            ...
            (new WorldGenLakes(Blocks.field_150355_j)).generate(this.worldObj, this.rand, blockpos.add(i1, j1, k1));
        }
        ...
        for (int k2 = 0; k2 < 16; ++k2)
        {
            for (int j3 = 0; j3 < 16; ++j3)
            {
                ...
                {
                    this.worldObj.func_180501_a(blockpos2, Blocks.ice.func_176223_P(), 2);
                }

                if (this.worldObj.canSnowAt(blockpos1, true))
                {
                    this.worldObj.func_180501_a(blockpos1, Blocks.snow_layer.func_176223_P(), 2);
                }
            }
        }
