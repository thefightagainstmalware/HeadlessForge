...
public class StructureOceanMonumentPieces
{
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
        {
            ...
            int j = this.boundingBox.field_78895_b;
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            int i = Math.max(worldIn.func_181545_F(), 64) - this.boundingBox.field_78895_b;
            ...
            for (StructureOceanMonumentPieces.Piece structureoceanmonumentpieces$piece : this.field_175843_q)
            {
                if (structureoceanmonumentpieces$piece.getBoundingBox().func_78884_a(structureBoundingBoxIn))
                {
    ...
    public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, 4, 7, 8, 5, 8, Blocks.gold_block.func_176223_P(), Blocks.gold_block.func_176223_P(), false);
    ...
    {
        protected static final IBlockState field_175828_a = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.ROUGH_META);
        protected static final IBlockState field_175826_b = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.BRICKS_META);
        protected static final IBlockState field_175827_c = Blocks.field_180397_cI.func_176203_a(BlockPrismarine.DARK_META);
        protected static final IBlockState field_175824_d = field_175826_b;
        protected static final IBlockState field_175825_e = Blocks.sea_lantern.func_176223_P();
        ...
        protected void func_181655_a(World p_181655_1_, StructureBoundingBox p_181655_2_, int p_181655_3_, int p_181655_4_, int p_181655_5_, int p_181655_6_, int p_181655_7_, int p_181655_8_, boolean p_181655_9_)
        {
            for (int i = p_181655_4_; i <= p_181655_7_; ++i)
            {
                for (int j = p_181655_3_; j <= p_181655_6_; ++j)
                {
                    ...
                    {
                        if (!p_181655_9_ || this.getBlockStateFromPos(p_181655_1_, j, i, k, p_181655_2_).func_177230_c().func_149688_o() != Material.field_151579_a)
                        {
                            if (this.getYWithOffset(i) >= p_181655_1_.func_181545_F())
                            {
                                this.setBlockState(p_181655_1_, Blocks.field_150350_a.func_176223_P(), j, i, k, p_181655_2_);
                            }
                            else
                            {
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_)
        {
            ...
            if (p_175817_2_.func_175898_b(new BlockPos(i, j, k)))
            {
                ...
                entityguardian.func_180482_a(worldIn.func_175649_E(new BlockPos(entityguardian)), (IEntityLivingData)null);
                worldIn.func_72838_d(entityguardian);
                return true;
            }
            else
            {
            ...
            for (int i = 1; i <= 6; ++i)
            {
                for (int j = 1; j <= 6; ++j)
                {
                    if (randomIn.nextInt(3) != 0)
                    {
                        ...
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, i, k, j, i, 3, j, Blocks.sponge.func_176203_a(1), Blocks.sponge.func_176203_a(1), false);
                    }
                }
            }
