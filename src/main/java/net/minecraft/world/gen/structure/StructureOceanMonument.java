    ...
    public static class StartMonument extends StructureStart
    {
        ...
        public void writeToNBT(NBTTagCompound tagCompound)
        {
            ...
            for (ChunkCoordIntPair chunkcoordintpair : this.field_175791_c)
            {
                ...
                nbttagcompound.func_74768_a("X", chunkcoordintpair.chunkXPos);
                nbttagcompound.func_74768_a("Z", chunkcoordintpair.chunkZPos);
                nbttaglist.func_74742_a(nbttagcompound);
            }

            tagCompound.func_74782_a("Processed", nbttaglist);
        }
