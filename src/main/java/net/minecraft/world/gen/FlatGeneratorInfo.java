...
public class FlatGeneratorInfo
{
    ...
    public static FlatGeneratorInfo getDefaultFlatGenerator()
    {
        ...
        flatgeneratorinfo.getFlatLayers().add(new FlatLayerInfo(1, Blocks.field_150357_h));
        flatgeneratorinfo.getFlatLayers().add(new FlatLayerInfo(2, Blocks.field_150346_d));
        flatgeneratorinfo.getFlatLayers().add(new FlatLayerInfo(1, Blocks.field_150349_c));
        flatgeneratorinfo.func_82645_d();
        flatgeneratorinfo.getWorldFeatures().put("village", Maps.<String, String>newHashMap());
        return flatgeneratorinfo;
    }
