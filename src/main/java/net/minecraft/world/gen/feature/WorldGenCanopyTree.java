...
{
    private static final IBlockState field_181640_a = Blocks.log2.func_176223_P().withProperty(BlockNewLog.VARIANT, BlockPlanks.EnumType.DARK_OAK);
    private static final IBlockState field_181641_b = Blocks.leaves2.func_176223_P().withProperty(BlockNewLeaf.VARIANT, BlockPlanks.EnumType.DARK_OAK).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
        ...
        if (k >= 1 && k + i + 1 < 256)
        {
            ...
            else
            {
                ...
                for (int j2 = 0; j2 < i; ++j2)
                {
                    ...
                    Material material = worldIn.func_180495_p(blockpos1).func_177230_c().func_149688_o();

                    if (material == Material.field_151579_a || material == Material.leaves)
                    {
