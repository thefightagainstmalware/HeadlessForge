...
public class WorldGenTallGrass extends WorldGenerator
{
    ...
    {
        this.tallGrassState = Blocks.tallgrass.func_176223_P().withProperty(BlockTallGrass.TYPE, p_i45629_1_);
    }
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        for (int i = 0; i < 128; ++i)
        {
            ...
            if (worldIn.func_175623_d(blockpos) && Blocks.tallgrass.canBlockStay(worldIn, blockpos, this.tallGrassState))
            {
