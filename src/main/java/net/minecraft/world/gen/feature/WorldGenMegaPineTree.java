...
{
    private static final IBlockState field_181633_e = Blocks.log.func_176223_P().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.SPRUCE);
    private static final IBlockState field_181634_f = Blocks.leaves.func_176223_P().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    private static final IBlockState field_181635_g = Blocks.field_150346_d.func_176223_P().withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.PODZOL);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        else
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                Block block = worldIn.func_180495_p(position.up(j)).func_177230_c();
                ...
                if (j < i - 1)
                {
                    block = worldIn.func_180495_p(position.add(1, j, 0)).func_177230_c();
                    ...
                    block = worldIn.func_180495_p(position.add(1, j, 1)).func_177230_c();
                    ...
                    block = worldIn.func_180495_p(position.add(0, j, 1)).func_177230_c();
