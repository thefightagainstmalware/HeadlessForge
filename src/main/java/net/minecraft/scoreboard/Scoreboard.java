...
public class Scoreboard
{
     ...
     */
    public ScoreObjective func_96518_b(String name)
    {
    ...
    public ScoreObjective addScoreObjective(String name, IScoreObjectiveCriteria criteria)
    {
        ...
        {
            ScoreObjective scoreobjective = this.func_96518_b(name);
     ...
     */
    public boolean func_178819_b(String name, ScoreObjective p_178819_2_)
    {
    ...
    {
        this.scoreObjectives.remove(p_96519_1_.func_96679_b());
        ...
        List<ScoreObjective> list = (List)this.scoreObjectiveCriterias.get(p_96519_1_.func_96680_c());
