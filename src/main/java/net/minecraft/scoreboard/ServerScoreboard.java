...
public class ServerScoreboard extends Scoreboard
{
    ...
    public void func_96536_a(Score p_96536_1_)
    {
        ...
        {
            this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3CPacketUpdateScore(p_96536_1_));
        }
    ...
    public void func_96516_a(String p_96516_1_)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3CPacketUpdateScore(p_96516_1_));
        this.func_96551_b();
    }
    ...
    public void func_178820_a(String p_178820_1_, ScoreObjective p_178820_2_)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3CPacketUpdateScore(p_178820_1_, p_178820_2_));
        this.func_96551_b();
    }
    ...
    public void setObjectiveInDisplaySlot(int p_96530_1_, ScoreObjective p_96530_2_)
    {
        ...
        if (scoreobjective != p_96530_2_ && scoreobjective != null)
        {
            ...
            {
                this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3DPacketDisplayScoreboard(p_96530_1_, p_96530_2_));
            }
            else
            {
    ...
    public boolean addPlayerToTeam(String player, String newTeam)
    {
        if (super.addPlayerToTeam(player, newTeam))
        {
            ...
            this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3EPacketTeams(scoreplayerteam, Arrays.asList(new String[] {player}), 3));
            this.func_96551_b();
            return true;
        }
        else
    ...
    public void removePlayerFromTeam(String p_96512_1_, ScorePlayerTeam p_96512_2_)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3EPacketTeams(p_96512_2_, Arrays.asList(new String[] {p_96512_1_}), 4));
        this.func_96551_b();
    }
    ...
    public void func_96532_b(ScoreObjective p_96532_1_)
    {
        ...
        {
            this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3BPacketScoreboardObjective(p_96532_1_, 2));
        }
    ...
    public void broadcastTeamCreated(ScorePlayerTeam playerTeam)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3EPacketTeams(playerTeam, 0));
        this.func_96551_b();
    }
    ...
    public void sendTeamUpdate(ScorePlayerTeam playerTeam)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3EPacketTeams(playerTeam, 2));
        this.func_96551_b();
    }
    ...
    public void func_96513_c(ScorePlayerTeam playerTeam)
    {
        ...
        this.scoreboardMCServer.func_71203_ab().func_148540_a(new S3EPacketTeams(playerTeam, 1));
        this.func_96551_b();
    }
    ...
    public void func_96549_e(ScoreObjective p_96549_1_)
    {
        ...
        for (EntityPlayerMP entityplayermp : this.scoreboardMCServer.func_71203_ab().func_181057_v())
        {
