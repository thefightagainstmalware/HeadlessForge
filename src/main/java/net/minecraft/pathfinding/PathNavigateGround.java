...
public class PathNavigateGround extends PathNavigate
{
    ...
    {
        return new Vec3(this.theEntity.field_70165_t, (double)this.getPathablePosY(), this.theEntity.field_70161_v);
    }
    ...
    private int getPathablePosY()
    {
        if (this.theEntity.isInWater() && this.getCanSwim())
        {
            ...
            Block block = this.worldObj.func_180495_p(new BlockPos(MathHelper.func_76128_c(this.theEntity.field_70165_t), i, MathHelper.func_76128_c(this.theEntity.field_70161_v))).func_177230_c();
            int j = 0;

            while (block == Blocks.field_150358_i || block == Blocks.field_150355_j)
            {
                ++i;
                block = this.worldObj.func_180495_p(new BlockPos(MathHelper.func_76128_c(this.theEntity.field_70165_t), i, MathHelper.func_76128_c(this.theEntity.field_70161_v))).func_177230_c();
                ++j;
    ...
    protected void removeSunnyPath()
    {
        ...
        {
            if (this.worldObj.canSeeSky(new BlockPos(MathHelper.func_76128_c(this.theEntity.field_70165_t), (int)(this.theEntity.getEntityBoundingBox().minY + 0.5D), MathHelper.func_76128_c(this.theEntity.field_70161_v))))
            {
                return;
            }
    ...
    private boolean isSafeToStandAt(int x, int y, int z, int sizeX, int sizeY, int sizeZ, Vec3 vec31, double p_179683_8_, double p_179683_10_)
    {
        ...
        else
        {
            for (int k = i; k < i + sizeX; ++k)
            {
                ...
                {
                    double d0 = (double)k + 0.5D - vec31.field_72450_a;
                    double d1 = (double)l + 0.5D - vec31.field_72449_c;

                    if (d0 * p_179683_8_ + d1 * p_179683_10_ >= 0.0D)
                    {
                        Block block = this.worldObj.func_180495_p(new BlockPos(k, y - 1, l)).func_177230_c();
