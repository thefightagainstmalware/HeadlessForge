...
public abstract class PathNavigate
{
    ...
    {
        return this.getPathToPos(new BlockPos(MathHelper.func_76128_c(x), (int)y, MathHelper.func_76128_c(z)));
    }
    ...
    {
        PathEntity pathentity = this.getPathToXYZ((double)MathHelper.func_76128_c(x), (double)((int)y), (double)MathHelper.func_76128_c(z));
    ...
    public void onUpdateNavigation()
    {
        ...
        if (!this.noPath())
        {
            ...
            else if (this.currentPath != null && this.currentPath.getCurrentPathIndex() < this.currentPath.getCurrentPathLength())
            {
                ...
                if (vec3.field_72448_b > vec31.field_72448_b && !this.theEntity.onGround && MathHelper.func_76128_c(vec3.field_72450_a) == MathHelper.func_76128_c(vec31.field_72450_a) && MathHelper.func_76128_c(vec3.field_72449_c) == MathHelper.func_76128_c(vec31.field_72449_c))
                {
            ...
            if (!this.noPath())
            {
                ...
                if (vec32 != null)
                {
                    AxisAlignedBB axisalignedbb1 = (new AxisAlignedBB(vec32.field_72450_a, vec32.field_72448_b, vec32.field_72449_c, vec32.field_72450_a, vec32.field_72448_b, vec32.field_72449_c)).expand(0.5D, 0.5D, 0.5D);
                    ...
                    this.theEntity.getMoveHelper().setMoveTo(vec32.field_72450_a, vec32.field_72448_b + d0, vec32.field_72449_c, this.speed);
                }
            }
        }
    }
    ...
    protected void pathFollow()
    {
        ...
        {
            if (this.currentPath.getPathPointFromIndex(j).yCoord != (int)vec3.field_72448_b)
            {
                i = j;
                break;
            }
