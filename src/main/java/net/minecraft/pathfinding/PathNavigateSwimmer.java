...
public class PathNavigateSwimmer extends PathNavigate
{
    ...
    {
        return new Vec3(this.theEntity.field_70165_t, this.theEntity.field_70163_u + (double)this.theEntity.height * 0.5D, this.theEntity.field_70161_v);
    }
    ...
    {
        MovingObjectPosition movingobjectposition = this.worldObj.rayTraceBlocks(posVec31, new Vec3(posVec32.field_72450_a, posVec32.field_72448_b + (double)this.theEntity.height * 0.5D, posVec32.field_72449_c), false, true, false);
