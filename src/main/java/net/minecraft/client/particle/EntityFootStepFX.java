...
public class EntityFootStepFX extends EntityFX
{
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        float f2 = 0.125F;
        float f3 = (float)(this.field_70165_t - interpPosX);
        float f4 = (float)(this.field_70163_u - interpPosY);
        float f5 = (float)(this.field_70161_v - interpPosZ);
        float f6 = this.field_70170_p.getLightBrightness(new BlockPos(this));
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            return new EntityFootStepFX(null, worldIn, xCoordIn, yCoordIn, zCoordIn);
        }
    }
}
