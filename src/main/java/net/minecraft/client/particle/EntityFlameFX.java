...
public class EntityFlameFX extends EntityFX
{
    ...
    protected EntityFlameFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
        ...
        this.field_70165_t += (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
        this.field_70163_u += (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
        this.field_70161_v += (double)((this.rand.nextFloat() - this.rand.nextFloat()) * 0.05F);
