...
public class EntityLavaFX extends EntityFX
{
    ...
    public void onUpdate()
    {
        ...
        {
            this.field_70170_p.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.field_70165_t, this.field_70163_u, this.field_70161_v, this.motionX, this.motionY, this.motionZ, new int[0]);
        }
