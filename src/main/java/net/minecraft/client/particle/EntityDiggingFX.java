...
public class EntityDiggingFX extends EntityFX
{
    ...
    protected EntityDiggingFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, IBlockState state)
    {
        ...
        this.particleGravity = state.func_177230_c().blockParticleGravity;
    ...
    public EntityDiggingFX func_174846_a(BlockPos pos)
    {
        ...
        {
            int i = this.field_174847_a.func_177230_c().colorMultiplier(this.field_70170_p, pos);
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
    {
        ...
        float f5 = (float)(this.prevPosX + (this.field_70165_t - this.prevPosX) * (double)partialTicks - interpPosX);
        float f6 = (float)(this.prevPosY + (this.field_70163_u - this.prevPosY) * (double)partialTicks - interpPosY);
        float f7 = (float)(this.prevPosZ + (this.field_70161_v - this.prevPosZ) * (double)partialTicks - interpPosZ);
    ...
    public int getBrightnessForRender(float partialTicks)
    {
        ...
        {
            j = this.field_70170_p.getCombinedLight(this.field_181019_az, 0);
        }
