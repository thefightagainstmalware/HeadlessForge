...
public class RenderGuardian extends RenderLiving<EntityGuardian>
{
        ...
        else
        {
            if (livingEntity.hasTargetedEntity())
            {
                ...
                if (entitylivingbase != null)
                {
                    ...
                    if (camera.isBoundingBoxInFrustum(AxisAlignedBB.fromBounds(vec31.field_72450_a, vec31.field_72448_b, vec31.field_72449_c, vec3.field_72450_a, vec3.field_72448_b, vec3.field_72449_c)))
                    {
                        return true;
                    }
                }
    ...
    {
        double d0 = entityLivingBaseIn.lastTickPosX + (entityLivingBaseIn.field_70165_t - entityLivingBaseIn.lastTickPosX) * (double)p_177110_4_;
        double d1 = p_177110_2_ + entityLivingBaseIn.lastTickPosY + (entityLivingBaseIn.field_70163_u - entityLivingBaseIn.lastTickPosY) * (double)p_177110_4_;
        double d2 = entityLivingBaseIn.lastTickPosZ + (entityLivingBaseIn.field_70161_v - entityLivingBaseIn.lastTickPosZ) * (double)p_177110_4_;
