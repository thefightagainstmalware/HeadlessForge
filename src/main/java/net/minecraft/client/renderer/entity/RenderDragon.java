...
public class RenderDragon extends RenderLiving<EntityDragon>
{
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
        ...
        f1 = (f1 * f1 + f1) * 0.2F;
        float f2 = (float)(dragon.healingEnderCrystal.field_70165_t - dragon.field_70165_t - (dragon.prevPosX - dragon.field_70165_t) * (double)(1.0F - p_180574_8_));
        float f3 = (float)((double)f1 + dragon.healingEnderCrystal.field_70163_u - 1.0D - dragon.field_70163_u - (dragon.prevPosY - dragon.field_70163_u) * (double)(1.0F - p_180574_8_));
        float f4 = (float)(dragon.healingEnderCrystal.field_70161_v - dragon.field_70161_v - (dragon.prevPosZ - dragon.field_70161_v) * (double)(1.0F - p_180574_8_));
