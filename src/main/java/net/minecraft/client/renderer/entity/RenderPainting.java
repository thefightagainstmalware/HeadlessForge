...
public class RenderPainting extends Render<EntityPainting>
{
    ...
    {
        int i = MathHelper.func_76128_c(painting.field_70165_t);
        int j = MathHelper.func_76128_c(painting.field_70163_u + (double)(p_77008_3_ / 16.0F));
        int k = MathHelper.func_76128_c(painting.field_70161_v);
        EnumFacing enumfacing = painting.facingDirection;

        if (enumfacing == EnumFacing.NORTH)
        {
            i = MathHelper.func_76128_c(painting.field_70165_t + (double)(p_77008_2_ / 16.0F));
        }

        if (enumfacing == EnumFacing.WEST)
        {
            k = MathHelper.func_76128_c(painting.field_70161_v - (double)(p_77008_2_ / 16.0F));
        }
