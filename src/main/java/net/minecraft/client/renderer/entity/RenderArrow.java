...
public class RenderArrow extends Render<EntityArrow>
{
    ...
    public void doRender(EntityArrow entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        GlStateManager.rotate(entity.prevRotationYaw + (entity.field_70177_z - entity.prevRotationYaw) * partialTicks - 90.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(entity.prevRotationPitch + (entity.field_70125_A - entity.prevRotationPitch) * partialTicks, 0.0F, 0.0F, 1.0F);
