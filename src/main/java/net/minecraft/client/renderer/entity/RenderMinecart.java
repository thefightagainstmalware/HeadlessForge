...
public class RenderMinecart<T extends EntityMinecart> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        double d0 = entity.lastTickPosX + (entity.field_70165_t - entity.lastTickPosX) * (double)partialTicks;
        double d1 = entity.lastTickPosY + (entity.field_70163_u - entity.lastTickPosY) * (double)partialTicks;
        double d2 = entity.lastTickPosZ + (entity.field_70161_v - entity.lastTickPosZ) * (double)partialTicks;
        double d3 = 0.30000001192092896D;
        Vec3 vec3 = entity.func_70489_a(d0, d1, d2);
        float f3 = entity.prevRotationPitch + (entity.field_70125_A - entity.prevRotationPitch) * partialTicks;
        ...
        if (vec3 != null)
        {
            ...
            x += vec3.field_72450_a - d0;
            y += (vec31.field_72448_b + vec32.field_72448_b) / 2.0D - d1;
            z += vec3.field_72449_c - d2;
            Vec3 vec33 = vec32.addVector(-vec31.field_72450_a, -vec31.field_72448_b, -vec31.field_72449_c);

            if (vec33.lengthVector() != 0.0D)
            {
                vec33 = vec33.normalize();
                entityYaw = (float)(Math.atan2(vec33.field_72449_c, vec33.field_72450_a) * 180.0D / Math.PI);
        ...
        if (iblockstate.func_177230_c().getRenderType() != -1)
        {
            GlStateManager.pushMatrix();
