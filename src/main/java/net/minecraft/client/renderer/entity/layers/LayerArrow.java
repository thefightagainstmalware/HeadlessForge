...
public class LayerArrow implements LayerRenderer<EntityLivingBase>
{
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
        ...
        if (i > 0)
        {
            Entity entity = new EntityArrow(entitylivingbaseIn.field_70170_p, entitylivingbaseIn.field_70165_t, entitylivingbaseIn.field_70163_u, entitylivingbaseIn.field_70161_v);
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                entity.prevRotationYaw = entity.field_70177_z = (float)(Math.atan2((double)f, (double)f2) * 180.0D / Math.PI);
                entity.prevRotationPitch = entity.field_70125_A = (float)(Math.atan2((double)f1, (double)f6) * 180.0D / Math.PI);
                double d0 = 0.0D;
                double d1 = 0.0D;
                double d2 = 0.0D;
