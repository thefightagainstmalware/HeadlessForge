...
public abstract class RenderLiving<T extends EntityLiving> extends RendererLivingEntity<T>
{
    ...
    protected void renderLeash(T entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entity != null)
        {
            ...
            double d0 = this.interpolateValue((double)entity.prevRotationYaw, (double)entity.field_70177_z, (double)(partialTicks * 0.5F)) * 0.01745329238474369D;
            double d1 = this.interpolateValue((double)entity.prevRotationPitch, (double)entity.field_70125_A, (double)(partialTicks * 0.5F)) * 0.01745329238474369D;
            ...
            double d6 = this.interpolateValue(entity.prevPosX, entity.field_70165_t, (double)partialTicks) - d2 * 0.7D - d3 * 0.5D * d5;
            double d7 = this.interpolateValue(entity.prevPosY + (double)entity.getEyeHeight() * 0.7D, entity.field_70163_u + (double)entity.getEyeHeight() * 0.7D, (double)partialTicks) - d4 * 0.5D - 0.25D;
            double d8 = this.interpolateValue(entity.prevPosZ, entity.field_70161_v, (double)partialTicks) - d3 * 0.7D + d2 * 0.5D * d5;
            ...
            double d10 = this.interpolateValue(entityLivingIn.prevPosX, entityLivingIn.field_70165_t, (double)partialTicks) + d2;
            double d11 = this.interpolateValue(entityLivingIn.prevPosY, entityLivingIn.field_70163_u, (double)partialTicks);
            double d12 = this.interpolateValue(entityLivingIn.prevPosZ, entityLivingIn.field_70161_v, (double)partialTicks) + d3;
            x = x + d2;
            z = z + d3;
