...
//
//        if (Minecraft.func_71410_x().field_71474_y.anaglyph)
//        {
...
//        dataBuffer.position(0).limit(p_110994_2_);
    ...
    {
        BufferedImage bufferedimage = func_177053_a(resourceManager.func_110536_a(imageLocation).func_110527_b());
    ...
    public static BufferedImage func_177053_a(InputStream imageStream) throws IOException
    {
