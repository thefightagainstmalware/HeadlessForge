...
public class RenderWitherSkull extends Render<EntityWitherSkull>
{
    ...
    public void doRender(EntityWitherSkull entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        float f = this.func_82400_a(entity.prevRotationYaw, entity.field_70177_z, partialTicks);
        float f1 = entity.prevRotationPitch + (entity.field_70125_A - entity.prevRotationPitch) * partialTicks;
