...
public class VisGraph
{
    ...
    {
        return getIndex(pos.func_177958_n() & 15, pos.func_177956_o() & 15, pos.func_177952_p() & 15);
    }
    ...
    private Set func_178604_a(int p_178604_1_)
    {
        ...
        arraydeque.add(IntegerCache.func_181756_a(p_178604_1_));
        ...
        while (!arraydeque.isEmpty())
        {
            ...
            for (EnumFacing enumfacing : EnumFacing.VALUES)
            {
                ...
                if (j >= 0 && !this.field_178612_d.get(j))
                {
                    ...
                    arraydeque.add(IntegerCache.func_181756_a(j));
                }
            }
        }
