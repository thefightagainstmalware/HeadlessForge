...
public class ViewFrustum
{
    ...
    {
        int i = MathHelper.func_76128_c(viewEntityX) - 8;
        int j = MathHelper.func_76128_c(viewEntityZ) - 8;
    ...
    {
        int i = MathHelper.bucketInt(pos.func_177958_n(), 16);
        int j = MathHelper.bucketInt(pos.func_177956_o(), 16);
        int k = MathHelper.bucketInt(pos.func_177952_p(), 16);
