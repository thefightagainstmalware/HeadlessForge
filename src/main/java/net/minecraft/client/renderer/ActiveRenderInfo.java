...
public class ActiveRenderInfo
{
    ...
    public static void updateRenderInfo(EntityPlayer entityplayerIn, boolean p_74583_1_)
    {
        ...
        float f2 = entityplayerIn.field_70125_A;
        float f3 = entityplayerIn.field_70177_z;
    ...
    {
        double d0 = p_178806_0_.prevPosX + (p_178806_0_.field_70165_t - p_178806_0_.prevPosX) * p_178806_1_;
        double d1 = p_178806_0_.prevPosY + (p_178806_0_.field_70163_u - p_178806_0_.prevPosY) * p_178806_1_;
        double d2 = p_178806_0_.prevPosZ + (p_178806_0_.field_70161_v - p_178806_0_.prevPosZ) * p_178806_1_;
        double d3 = d0 + position.field_72450_a;
        double d4 = d1 + position.field_72448_b;
        double d5 = d2 + position.field_72449_c;
    ...
    public static Block getBlockAtEntityViewpoint(World worldIn, Entity p_180786_1_, float p_180786_2_)
    {
        ...
        if (block.func_149688_o().func_76224_d())
        {
            ...
            {
                block = worldIn.func_180495_p(blockpos.up()).func_177230_c();
            }
        }
