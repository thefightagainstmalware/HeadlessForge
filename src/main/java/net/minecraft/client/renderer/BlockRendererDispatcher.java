...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public boolean renderBlock(IBlockState state, BlockPos pos, IBlockAccess blockAccess, WorldRenderer worldRendererIn)
    {
        try
        {
            int i = state.func_177230_c().getRenderType();
        ...
        catch (Throwable throwable)
        {
            ...
            CrashReportCategory.addBlockInfo(crashreportcategory, pos, state.func_177230_c(), state.func_177230_c().func_176201_c(state));
    ...
    public void renderBlockBrightness(IBlockState state, float brightness)
    {
        ...
        if (i != -1)
        {
            switch (i)
            {
                ...
                case 2:
                    this.chestRenderer.renderChestBrightness(state.func_177230_c(), brightness);
                    break;
