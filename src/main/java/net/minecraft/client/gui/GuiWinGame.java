...
public class GuiWinGame extends GuiScreen
{
    ...
    public void initGui()
    {
        if (this.field_146582_i == null)
        {
            ...
            try
            {
                ...
                int i = 274;
                InputStream inputstream = this.mc.func_110442_L().func_110536_a(new ResourceLocation("texts/end.txt")).func_110527_b();
                ...
                while ((s = bufferedreader.readLine()) != null)
                {
                    ...
                    for (s = s.replaceAll("PLAYERNAME", this.mc.func_110432_I().func_111285_a()); s.contains(s1); s = s2 + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s3)
                    {
                        int j = s.indexOf(s1);
                        s2 = s.substring(0, j);
                ...
                inputstream = this.mc.func_110442_L().func_110536_a(new ResourceLocation("texts/credits.txt")).func_110527_b();
                bufferedreader = new BufferedReader(new InputStreamReader(inputstream, Charsets.UTF_8));

                while ((s = bufferedreader.readLine()) != null)
                {
                    s = s.replaceAll("PLAYERNAME", this.mc.func_110432_I().func_111285_a());
                    s = s.replaceAll("\t", "    ");
                    this.field_146582_i.addAll(this.mc.fontRendererObj.listFormattedStringToWidth(s, i));
                    this.field_146582_i.add("");
                }
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_)
    {
        ...
        this.mc.func_110434_K().func_110577_a(Gui.optionsBackground);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.func_110434_K().func_110577_a(MINECRAFT_LOGO);
        ...
        this.mc.func_110434_K().func_110577_a(VIGNETTE_TEXTURE);
