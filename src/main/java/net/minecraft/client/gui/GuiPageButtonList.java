...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    {
        GuiTextField guitextfield = new GuiTextField(p_178068_3_.func_178935_b(), null, p_178068_1_, p_178068_2_, 150, 20);
    ...
    private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_)
    {
        ...
        if (p_178063_4_)
        {
            guilabel = new GuiLabel(null, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
        }
        else
        {
            guilabel = new GuiLabel(null, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
        }
