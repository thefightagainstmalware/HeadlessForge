...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData p_i45048_2_)
    {
        ...
        this.field_148305_h = (DynamicTexture)this.mc.func_110434_K().getTexture(this.field_148306_i);
    }
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        this.mc.func_110434_K().func_110577_a(Gui.icons);
        ...
        if (this.mc.field_71474_y.touchscreen || isSelected)
        {
            this.mc.func_110434_K().func_110577_a(SERVER_SELECTION_BUTTONS);
    ...
    {
        this.mc.func_110434_K().func_110577_a(p_178012_3_);
    ...
    private void prepareServerIcon()
    {
        ...
        {
            this.mc.func_110434_K().deleteTexture(this.field_148306_i);
        ...
        else
        {
            ...
            if (this.field_148305_h == null)
            {
                ...
                this.mc.func_110434_K().loadTexture(this.field_148306_i, this.field_148305_h);
            }
