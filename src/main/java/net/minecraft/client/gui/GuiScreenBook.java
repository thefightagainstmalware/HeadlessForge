...
public class GuiScreenBook extends GuiScreen
{
    ...
    private void sendBookToServer(boolean publish) throws IOException
    {
        if (this.bookIsUnsigned && this.bookIsModified)
        {
            if (this.bookPages != null)
            {
                while (this.bookPages.func_74745_c() > 1)
                {
                    String s = this.bookPages.getStringTagAt(this.bookPages.func_74745_c() - 1);
                    ...
                    this.bookPages.removeTag(this.bookPages.func_74745_c() - 1);
                }

                if (this.bookObj.func_77942_o())
                {
                    NBTTagCompound nbttagcompound = this.bookObj.func_77978_p();
                    nbttagcompound.func_74782_a("pages", this.bookPages);
                }
                else
                {
                ...
                if (publish)
                {
                    ...
                    for (int i = 0; i < this.bookPages.func_74745_c(); ++i)
                    {
    ...
    {
        return this.bookPages != null && this.currPage >= 0 && this.currPage < this.bookPages.func_74745_c() ? this.bookPages.getStringTagAt(this.currPage) : "";
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            String s2 = I18n.format("book.byAuthor", new Object[] {this.editingPlayer.func_70005_c_()});
        ...
        else
        {
            ...
            {
                if (ItemEditableBook.validBookTagContents(this.bookObj.func_77978_p()))
                {
                    try
                    {
            ...
            else
            {
                ...
                for (int l1 = 0; l1 < k1; ++l1)
                {
                    ...
                    this.fontRendererObj.drawString(ichatcomponent2.func_150260_c(), i + 36, j + 16 + 16 + l1 * this.fontRendererObj.FONT_HEIGHT, 0);
                }
    ...
    {
        ClickEvent clickevent = p_175276_1_ == null ? null : p_175276_1_.func_150256_b().getChatClickEvent();
    ...
    static class NextPageButton extends GuiButton
    {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY)
        {
            if (this.visible)
            {
                ...
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                mc.func_110434_K().func_110577_a(GuiScreenBook.bookGuiTextures);
                int i = 0;
                int j = 192;
