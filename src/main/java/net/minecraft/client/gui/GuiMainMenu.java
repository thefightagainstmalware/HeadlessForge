...
//        }
    ...
    public void initGui()
    {
        ...
        this.backgroundTexture = this.mc.func_110434_K().getDynamicTextureLocation("background", this.viewportTexture);
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int j = 0; j < i * i; ++j)
        {
            ...
            for (int k = 0; k < 6; ++k)
            {
                ...
                this.mc.func_110434_K().func_110577_a(titlePanoramaPaths[k]);
    ...
    {
        this.mc.func_110434_K().func_110577_a(this.backgroundTexture);
...
//        GL11.glCopyTexSubImage2D(GL11.GL_TEXTURE_2D, 0, 0, 0, 0, 0, 256, 256);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.func_110434_K().func_110577_a(minecraftTitleTextures);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
