    ...
    class List extends GuiSlot
    {
        ...
        public List(Minecraft mcIn)
        {
            ...
            for (Language language : GuiLanguage.this.languageManager.getLanguages())
            {
                ...
                this.langCodeList.add(language.func_135034_a());
            }
        }
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
        {
            ...
            GuiLanguage.this.game_settings_3.language = language.func_135034_a();
        ...
        {
            return ((String)this.langCodeList.get(slotIndex)).equals(GuiLanguage.this.languageManager.func_135041_c().func_135034_a());
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn)
        {
            ...
            GuiLanguage.this.fontRendererObj.setBidiFlag(GuiLanguage.this.languageManager.func_135041_c().isBidirectional());
        }
    }
}
