...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    {
        boolean flag = !this.sndRegistry.func_148741_d(location);
        SoundEventAccessorComposite soundeventaccessorcomposite;

        if (!flag && !sounds.canReplaceExisting())
        {
            soundeventaccessorcomposite = (SoundEventAccessorComposite)this.sndRegistry.func_82594_a(location);
        }
        else
        {
            if (!flag)
        ...
        for (final SoundList.SoundEntry soundlist$soundentry : sounds.getSoundList())
        {
            ...
            final String s1 = s.contains(":") ? resourcelocation.func_110624_b() : location.func_110624_b();
            Object lvt_10_1_;
            ...
            switch (soundlist$soundentry.getSoundEntryType())
            {
                case FILE:
                    ...
                    try
                    {
                        inputstream = this.mcResourceManager.func_110536_a(resourcelocation1).func_110527_b();
                    }
                ...
                case SOUND_EVENT:
                    lvt_10_1_ = new ISoundEventAccessor<SoundPoolEntry>()
                    {
                        ...
                        {
                            SoundEventAccessorComposite soundeventaccessorcomposite1 = (SoundEventAccessorComposite)SoundHandler.this.sndRegistry.func_82594_a(this.field_148726_a);
    ...
    {
        return (SoundEventAccessorComposite)this.sndRegistry.func_82594_a(location);
    }
    ...
    public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory... categories)
    {
        ...
        for (ResourceLocation resourcelocation : this.sndRegistry.func_148742_b())
        {
            SoundEventAccessorComposite soundeventaccessorcomposite = (SoundEventAccessorComposite)this.sndRegistry.func_82594_a(resourcelocation);
