...
public abstract class BlockBasePressurePlate extends Block
{
    ...
    {
        this.setBlockBoundsBasedOnState0(worldIn.func_180495_p(pos));
    }
    ...
    {
        return World.doesBlockHaveSolidTopSurface(worldIn, pos) || worldIn.func_180495_p(pos).func_177230_c() instanceof BlockFence;
    }
    ...
    protected void updateState(World worldIn, BlockPos pos, IBlockState state, int oldRedstoneStrength)
    {
        ...
        if (!flag1 && flag)
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, 0.5F);
        }
        else if (flag1 && !flag)
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, 0.6F);
        }
