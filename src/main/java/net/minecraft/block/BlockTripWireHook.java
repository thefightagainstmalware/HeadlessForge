...
public class BlockTripWireHook extends Block
{
    ...
    {
        return state.withProperty(SUSPENDED, Boolean.valueOf(!World.doesBlockHaveSolidTopSurface(worldIn, pos.func_177977_b())));
    }
    ...
    {
        return side.getAxis().isHorizontal() && worldIn.func_180495_p(pos.offset(side.getOpposite())).func_177230_c().isNormalCube();
    }
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
    {
        for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            if (worldIn.func_180495_p(pos.offset(enumfacing)).func_177230_c().isNormalCube())
            {
                return true;
            }
        }
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(POWERED, Boolean.valueOf(false)).withProperty(ATTACHED, Boolean.valueOf(false)).withProperty(SUSPENDED, Boolean.valueOf(false));
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        if (neighborBlock != this)
        {
            if (this.checkForDrop(worldIn, pos, state))
            {
                ...
                if (!worldIn.func_180495_p(pos.offset(enumfacing.getOpposite())).func_177230_c().isNormalCube())
                {
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_)
    {
        ...
        boolean flag2 = !World.doesBlockHaveSolidTopSurface(worldIn, pos.func_177977_b());
        ...
        for (int j = 1; j < 42; ++j)
        {
            ...
            if (iblockstate.func_177230_c() == Blocks.tripwire_hook)
            {
            ...
            if (iblockstate.func_177230_c() != Blocks.tripwire && j != p_176260_6_)
            {
                aiblockstate[j] = null;
                flag3 = false;
            }
        ...
        flag3 = flag3 & i > 1;
        flag4 = flag4 & flag3;
        IBlockState iblockstate1 = this.func_176223_P().withProperty(ATTACHED, Boolean.valueOf(flag3)).withProperty(POWERED, Boolean.valueOf(flag4));

        if (i > 0)
        {
            BlockPos blockpos1 = pos.offset(enumfacing, i);
            EnumFacing enumfacing1 = enumfacing.getOpposite();
            worldIn.func_180501_a(blockpos1, iblockstate1.withProperty(FACING, enumfacing1), 3);
        ...
        if (!p_176260_4_)
        {
            worldIn.func_180501_a(pos, iblockstate1.withProperty(FACING, enumfacing), 3);
        ...
        if (flag != flag3)
        {
            for (int k = 1; k < i; ++k)
            {
                ...
                if (iblockstate2 != null && worldIn.func_180495_p(blockpos2).func_177230_c() != Blocks.field_150350_a)
                {
                    worldIn.func_180501_a(blockpos2, iblockstate2.withProperty(ATTACHED, Boolean.valueOf(flag3)), 3);
                }
            }
        }
    }
    ...
    private void func_180694_a(World worldIn, BlockPos pos, boolean p_180694_3_, boolean p_180694_4_, boolean p_180694_5_, boolean p_180694_6_)
    {
        ...
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.4F, 0.6F);
        }
        else if (!p_180694_4_ && p_180694_6_)
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.4F, 0.5F);
        }
        else if (p_180694_3_ && !p_180694_5_)
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.4F, 0.7F);
        }
        else if (!p_180694_3_ && p_180694_5_)
        {
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.1D, (double)pos.func_177952_p() + 0.5D, "random.bowhit", 0.4F, 1.2F / (worldIn.rand.nextFloat() * 0.2F + 0.9F));
        }
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, EnumFacing.getHorizontal(meta & 3)).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0)).withProperty(ATTACHED, Boolean.valueOf((meta & 4) > 0));
    }
