...
public class BlockCocoa extends BlockDirectional implements IGrowable
{
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        return iblockstate.func_177230_c() == Blocks.log && iblockstate.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.JUNGLE;
    }
    ...
    {
        EnumFacing enumfacing = EnumFacing.fromAngle((double)placer.field_70177_z);
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        return this.func_176223_P().withProperty(FACING, facing.getOpposite()).withProperty(AGE, Integer.valueOf(0));
    }
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            spawnAsEntity(worldIn, pos, new ItemStack(Items.field_151100_aR, 1, EnumDyeColor.BROWN.getDyeDamage()));
        }
    }
    ...
    {
        worldIn.func_180501_a(pos, state.withProperty(AGE, Integer.valueOf(((Integer)state.getValue(AGE)).intValue() + 1)), 2);
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, EnumFacing.getHorizontal(meta)).withProperty(AGE, Integer.valueOf((meta & 15) >> 2));
    }
