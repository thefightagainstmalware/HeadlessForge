...
public class BlockFence extends Block
{
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block == Blocks.field_180401_cv ? false : ((!(block instanceof BlockFence) || block.blockMaterial != this.blockMaterial) && !(block instanceof BlockFenceGate) ? (block.blockMaterial.isOpaque() && block.func_149686_d() ? block.blockMaterial != Material.gourd : false) : true);
    }
