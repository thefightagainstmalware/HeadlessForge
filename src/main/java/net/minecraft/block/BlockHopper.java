...
public class BlockHopper extends BlockContainer
{
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        return this.func_176223_P().withProperty(FACING, enumfacing).withProperty(ENABLED, Boolean.valueOf(true));
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityHopper)
            {
                ...
                playerIn.func_71029_a(StatList.field_181732_P);
            }
    ...
    private void updateState(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            worldIn.func_180501_a(pos, state.withProperty(ENABLED, Boolean.valueOf(flag)), 4);
        }
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, getFacing(meta)).withProperty(ENABLED, Boolean.valueOf(isEnabled(meta)));
    }
