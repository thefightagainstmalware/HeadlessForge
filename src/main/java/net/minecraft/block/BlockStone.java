...
public class BlockStone extends Block
{
    ...
    {
        return state.getValue(VARIANT) == BlockStone.EnumType.STONE ? Item.func_150898_a(Blocks.field_150347_e) : Item.func_150898_a(Blocks.field_150348_b);
    }
    ...
    {
        return ((BlockStone.EnumType)state.getValue(VARIANT)).func_176642_a();
    }
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        {
            list.add(new ItemStack(itemIn, 1, blockstone$enumtype.func_176642_a()));
        }
    }
    ...
    {
        return this.func_176223_P().withProperty(VARIANT, BlockStone.EnumType.byMetadata(meta));
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static {
            ...
            {
                META_LOOKUP[blockstone$enumtype.func_176642_a()] = blockstone$enumtype;
            }
        }
    }
}
