...
public class BlockTrapDoor extends Block
{
    ...
    {
        this.setBounds(worldIn.func_180495_p(pos));
    }
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        if (!worldIn.isRemote)
        {
            ...
            if (!isValidSupportBlock(worldIn.func_180495_p(blockpos).func_177230_c()))
            {
    ...
    {
        return !side.getAxis().isVertical() && isValidSupportBlock(worldIn.func_180495_p(pos.offset(side.getOpposite())).func_177230_c());
    }
    ...
    {
        return blockIn.blockMaterial.isOpaque() && blockIn.func_149686_d() || blockIn == Blocks.glowstone || blockIn instanceof BlockSlab || blockIn instanceof BlockStairs;
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, getFacing(meta)).withProperty(OPEN, Boolean.valueOf((meta & 4) != 0)).withProperty(HALF, (meta & 8) == 0 ? BlockTrapDoor.DoorHalf.BOTTOM : BlockTrapDoor.DoorHalf.TOP);
    }
