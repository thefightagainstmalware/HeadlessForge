...
public class BlockAnvil extends BlockFalling
{
    ...
    {
        return this.func_176223_P().withProperty(FACING, EnumFacing.getHorizontal(meta & 3)).withProperty(DAMAGE, Integer.valueOf((meta & 15) >> 2));
    }
    ...
    public static class Anvil implements IInteractionObject
    {
        ...
        {
            return new ChatComponentTranslation(Blocks.field_150467_bQ.getUnlocalizedName() + ".name", new Object[0]);
        }
