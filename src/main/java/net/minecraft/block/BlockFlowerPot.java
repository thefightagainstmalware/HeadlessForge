...
public class BlockFlowerPot extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if (itemstack != null && itemstack.func_77973_b() instanceof ItemBlock)
        {
            ...
            {
                Block block = Block.getBlockFromItem(itemstack.func_77973_b());
                ...
                {
                    tileentityflowerpot.setFlowerPotData(itemstack.func_77973_b(), itemstack.getMetadata());
                    tileentityflowerpot.func_70296_d();
                    worldIn.func_175689_h(pos);
                    playerIn.func_71029_a(StatList.field_181736_T);

                    if (!playerIn.field_71075_bZ.field_75098_d && --itemstack.field_77994_a <= 0)
                    {
    ...
    {
        return blockIn != Blocks.yellow_flower && blockIn != Blocks.red_flower && blockIn != Blocks.cactus && blockIn != Blocks.brown_mushroom && blockIn != Blocks.red_mushroom && blockIn != Blocks.field_150345_g && blockIn != Blocks.field_150330_I ? blockIn == Blocks.tallgrass && meta == BlockTallGrass.EnumType.FERN.getMeta() : true;
    }
    ...
    {
        return super.canPlaceBlockAt(worldIn, pos) && World.doesBlockHaveSolidTopSurface(worldIn, pos.func_177977_b());
    }
