...
public class BlockPistonExtension extends Block
{
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if ((iblockstate.func_177230_c() == Blocks.piston || iblockstate.func_177230_c() == Blocks.sticky_piston) && ((Boolean)iblockstate.getValue(BlockPistonBase.EXTENDED)).booleanValue())
        {
            iblockstate.func_177230_c().dropBlockAsItem(worldIn, pos, iblockstate, 0);
    ...
    {
        this.applyHeadBounds(worldIn.func_180495_p(pos));
    }
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        if (iblockstate.func_177230_c() != Blocks.piston && iblockstate.func_177230_c() != Blocks.sticky_piston)
        {
            worldIn.setBlockToAir(pos);
        }
        else
        {
            iblockstate.func_177230_c().onNeighborBlockChange(worldIn, blockpos, iblockstate, neighborBlock);
        }
    }
    ...
    {
        return worldIn.func_180495_p(pos).getValue(TYPE) == BlockPistonExtension.EnumPistonType.STICKY ? Item.func_150898_a(Blocks.sticky_piston) : Item.func_150898_a(Blocks.piston);
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, getFacing(meta)).withProperty(TYPE, (meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
