...
public class BlockDirt extends Block
{
    ...
    public int getDamageValue(World worldIn, BlockPos pos)
    {
        ...
        return iblockstate.func_177230_c() != this ? 0 : ((BlockDirt.DirtType)iblockstate.getValue(VARIANT)).getMetadata();
    }
    ...
    {
        return this.func_176223_P().withProperty(VARIANT, BlockDirt.DirtType.byMetadata(meta));
    }
