...
{
    public static final Material field_151579_a = new MaterialTransparent(MapColor.airColor);
    ...
    public static final Material field_151581_o = (new MaterialTransparent(MapColor.airColor)).setNoPushMobility();
