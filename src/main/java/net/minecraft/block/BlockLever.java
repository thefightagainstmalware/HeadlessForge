...
public class BlockLever extends Block
{
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(POWERED, Boolean.valueOf(false));
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        switch ((BlockLever.EnumOrientation)worldIn.func_180495_p(pos).getValue(FACING))
        {
            case EAST:
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, ((Boolean)state.getValue(POWERED)).booleanValue() ? 0.6F : 0.5F);
    ...
    {
        return this.func_176223_P().withProperty(FACING, BlockLever.EnumOrientation.byMetadata(meta & 7)).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0));
    }
