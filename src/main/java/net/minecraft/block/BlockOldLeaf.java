...
public class BlockOldLeaf extends BlockLeaves
{
    ...
    {
        return new ItemStack(Item.func_150898_a(this), 1, ((BlockPlanks.EnumType)state.getValue(VARIANT)).getMetadata());
    }
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te)
    {
        if (!worldIn.isRemote && player.func_71045_bC() != null && player.func_71045_bC().func_77973_b() == Items.shears)
        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(Item.func_150898_a(this), 1, ((BlockPlanks.EnumType)state.getValue(VARIANT)).getMetadata()));
        }
        else
        {
