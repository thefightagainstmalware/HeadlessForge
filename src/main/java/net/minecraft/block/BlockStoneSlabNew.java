...
public abstract class BlockStoneSlabNew extends BlockSlab
{
    ...
    {
        return Item.func_150898_a(Blocks.stone_slab2);
    }
    ...
    {
        if (itemIn != Item.func_150898_a(Blocks.double_stone_slab2))
        {
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(VARIANT, BlockStoneSlabNew.EnumType.byMetadata(meta & 7));
