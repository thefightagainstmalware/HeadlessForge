...
public class BlockTorch extends Block
{
    ...
    private boolean canPlaceOn(World worldIn, BlockPos pos)
    {
        ...
        else
        {
            ...
            return block instanceof BlockFence || block == Blocks.glass || block == Blocks.cobblestone_wall || block == Blocks.field_150399_cn;
        }
    }
    ...
    {
        if (state.func_177230_c() == this && this.canPlaceAt(worldIn, pos, (EnumFacing)state.getValue(FACING)))
        {
            return true;
        }
        else
