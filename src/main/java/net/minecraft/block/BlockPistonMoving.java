...
public class BlockPistonMoving extends BlockContainer
{
    ...
    public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (iblockstate.func_177230_c() instanceof BlockPistonBase && ((Boolean)iblockstate.getValue(BlockPistonBase.EXTENDED)).booleanValue())
        {
    ...
    {
        if (extendingBlock.func_177230_c() != this && extendingBlock.func_177230_c().func_149688_o() != Material.field_151579_a)
        {
            AxisAlignedBB axisalignedbb = extendingBlock.func_177230_c().getCollisionBoundingBox(worldIn, pos, extendingBlock);
    ...
    {
        return this.func_176223_P().withProperty(FACING, BlockPistonExtension.getFacing(meta)).withProperty(TYPE, (meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
    }
