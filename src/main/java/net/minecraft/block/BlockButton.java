...
public abstract class BlockButton extends Block
{
    ...
    protected static boolean func_181088_a(World p_181088_0_, BlockPos p_181088_1_, EnumFacing p_181088_2_)
    {
        ...
        return p_181088_2_ == EnumFacing.DOWN ? World.doesBlockHaveSolidTopSurface(p_181088_0_, blockpos) : p_181088_0_.func_180495_p(blockpos).func_177230_c().isNormalCube();
    }
    ...
    {
        return func_181088_a(worldIn, pos, facing.getOpposite()) ? this.func_176223_P().withProperty(FACING, facing).withProperty(POWERED, Boolean.valueOf(false)) : this.func_176223_P().withProperty(FACING, EnumFacing.DOWN).withProperty(POWERED, Boolean.valueOf(false));
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, 0.6F);
        ...
        if (!worldIn.isRemote)
        {
            if (((Boolean)state.getValue(POWERED)).booleanValue())
            {
                ...
                else
                {
                    ...
                    this.notifyNeighbors(worldIn, pos, (EnumFacing)state.getValue(FACING));
                    worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, 0.5F);
                    worldIn.markBlockRangeForRenderUpdate(pos, pos);
                }
            }
        }
    ...
    private void checkForArrows(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        List <? extends Entity > list = worldIn.<Entity>getEntitiesWithinAABB(EntityArrow.class, new AxisAlignedBB((double)pos.func_177958_n() + this.minX, (double)pos.func_177956_o() + this.minY, (double)pos.func_177952_p() + this.minZ, (double)pos.func_177958_n() + this.maxX, (double)pos.func_177956_o() + this.maxY, (double)pos.func_177952_p() + this.maxZ));
    ...
    public IBlockState func_176203_a(int meta)
    {
        ...
        return this.func_176223_P().withProperty(FACING, enumfacing).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0));
    }
