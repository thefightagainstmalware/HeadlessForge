...
public abstract class BlockStateBase implements IBlockState
{
    ...
    public ResourceLocation getBlockLocation()
    {
        ...
        {
            this.blockLocation = (ResourceLocation)Block.field_149771_c.getNameForObject(this.func_177230_c());
        }
    ...
    public String toString()
    {
        ...
        stringbuilder.append(Block.field_149771_c.getNameForObject(this.func_177230_c()));
