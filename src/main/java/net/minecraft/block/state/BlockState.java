...
public class BlockState
{
    ...
    {
        return Objects.toStringHelper(this).add("block", Block.field_149771_c.getNameForObject(this.block)).add("properties", Iterables.transform(this.properties, GET_NAME_FUNC)).toString();
    }
    ...
    static class StateImplementation extends BlockStateBase
    {
        ...
        public <T extends Comparable<T>, V extends T> IBlockState withProperty(IProperty<T> property, V value)
        {
            ...
            {
                throw new IllegalArgumentException("Cannot set property " + property + " to " + value + " on block " + Block.field_149771_c.getNameForObject(this.block) + ", it is not an allowed value");
            }
            else
            {
