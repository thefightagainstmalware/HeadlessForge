...
public class BlockPistonStructureHelper
{
    ...
    public boolean canMove()
    {
        ...
        Block block = this.world.func_180495_p(this.blockToMove).func_177230_c();
        ...
        else
        {
            for (int i = 0; i < this.toMove.size(); ++i)
            {
                ...
                if (this.world.func_180495_p(blockpos).func_177230_c() == Blocks.slime_block && !this.func_177250_b(blockpos))
                {
                    return false;
                }
            }
    ...
    {
        Block block = this.world.func_180495_p(origin).func_177230_c();
        ...
        else
        {
            ...
            else
            {
                while (block == Blocks.slime_block)
                {
                    ...
                    if (block.func_149688_o() == Material.field_151579_a || !BlockPistonBase.canPush(block, this.world, blockpos, this.moveDirection, false) || blockpos.equals(this.pistonPos))
                    {
                        break;
                    }
                ...
                while (true)
                {
                    ...
                    if (k > -1)
                    {
                        ...
                        for (int l = 0; l <= k + i1; ++l)
                        {
                            ...
                            if (this.world.func_180495_p(blockpos2).func_177230_c() == Blocks.slime_block && !this.func_177250_b(blockpos2))
                            {
                                return false;
                            }
                        }
                    ...
                    block = this.world.func_180495_p(blockpos1).func_177230_c();
