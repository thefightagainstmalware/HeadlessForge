...
public class BlockPattern
{
    ...
    protected static BlockPos translateOffset(BlockPos pos, EnumFacing finger, EnumFacing thumb, int palmOffset, int thumbOffset, int fingerOffset)
    {
        if (finger != thumb && finger != thumb.getOpposite())
        {
            ...
            return pos.add(vec3i1.func_177958_n() * -thumbOffset + vec3i2.func_177958_n() * palmOffset + vec3i.func_177958_n() * fingerOffset, vec3i1.func_177956_o() * -thumbOffset + vec3i2.func_177956_o() * palmOffset + vec3i.func_177956_o() * fingerOffset, vec3i1.func_177952_p() * -thumbOffset + vec3i2.func_177952_p() * palmOffset + vec3i.func_177952_p() * fingerOffset);
        }
        else
        {
