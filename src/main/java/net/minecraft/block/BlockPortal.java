...
public class BlockPortal extends BlockBreakable
{
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (worldIn.provider.isSurfaceWorld() && worldIn.func_82736_K().func_82766_b("doMobSpawning") && rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId())
        {
            int i = pos.func_177956_o();
            BlockPos blockpos;

            for (blockpos = pos; !World.doesBlockHaveSolidTopSurface(worldIn, blockpos) && blockpos.func_177956_o() > 0; blockpos = blockpos.func_177977_b())
            {
                ;
            }

            if (i > 0 && !worldIn.func_180495_p(blockpos.up()).func_177230_c().isNormalCube())
            {
                Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, 57, (double)blockpos.func_177958_n() + 0.5D, (double)blockpos.func_177956_o() + 1.1D, (double)blockpos.func_177952_p() + 0.5D);
    ...
    {
        EnumFacing.Axis enumfacing$axis = (EnumFacing.Axis)worldIn.func_180495_p(pos).getValue(AXIS);
        float f = 0.125F;
        float f1 = 0.125F;
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        if (enumfacing$axis == EnumFacing.Axis.X)
        {
            ...
            {
                worldIn.setBlockState(pos, Blocks.field_150350_a.func_176223_P());
            }
        }
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        ...
        boolean flag = worldIn.func_180495_p(pos.west()).func_177230_c() == this && worldIn.func_180495_p(pos.west(2)).func_177230_c() != this;
        boolean flag1 = worldIn.func_180495_p(pos.east()).func_177230_c() == this && worldIn.func_180495_p(pos.east(2)).func_177230_c() != this;
        boolean flag2 = worldIn.func_180495_p(pos.north()).func_177230_c() == this && worldIn.func_180495_p(pos.north(2)).func_177230_c() != this;
        boolean flag3 = worldIn.func_180495_p(pos.south()).func_177230_c() == this && worldIn.func_180495_p(pos.south(2)).func_177230_c() != this;
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        {
            worldIn.playSound((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, "portal.portal", 0.5F, rand.nextFloat() * 0.4F + 0.8F, false);
        }
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            if (worldIn.func_180495_p(pos.west()).func_177230_c() != this && worldIn.func_180495_p(pos.east()).func_177230_c() != this)
            {
                d0 = (double)pos.func_177958_n() + 0.5D + 0.25D * (double)j;
                d3 = (double)(rand.nextFloat() * 2.0F * (float)j);
            }
            else
            {
                d2 = (double)pos.func_177952_p() + 0.5D + 0.25D * (double)j;
    ...
    {
        return this.func_176223_P().withProperty(AXIS, (meta & 3) == 2 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
    }
            ...
            for (EnumFacing.AxisDirection enumfacing$axisdirection : EnumFacing.AxisDirection.values())
            {
                ...
                for (int i = 0; i < blockportal$size.func_181101_b(); ++i)
                {
                    for (int j = 0; j < blockportal$size.func_181100_a(); ++j)
                    {
                        ...
                        if (blockworldstate.getBlockState() != null && blockworldstate.getBlockState().func_177230_c().func_149688_o() != Material.field_151579_a)
                        {
    ...
    public static class Size
    {
        ...
        protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
        {
            ...
            for (i = 0; i < 22; ++i)
            {
                ...
                if (!this.func_150857_a(this.world.func_180495_p(blockpos).func_177230_c()) || this.world.func_180495_p(blockpos.func_177977_b()).func_177230_c() != Blocks.field_150343_Z)
                {
                    break;
                }
            }

            Block block = this.world.func_180495_p(p_180120_1_.offset(p_180120_2_, i)).func_177230_c();
        ...
        protected int func_150858_a()
        {
            ...
            for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    if (i == 0)
                    {
                        block = this.world.func_180495_p(blockpos.offset(this.field_150863_d)).func_177230_c();
                    ...
                    {
                        block = this.world.func_180495_p(blockpos.offset(this.field_150866_c)).func_177230_c();
            ...
            {
                if (this.world.func_180495_p(this.field_150861_f.offset(this.field_150866_c, j).up(this.field_150862_g)).func_177230_c() != Blocks.field_150343_Z)
                {
        ...
        {
            return p_150857_1_.blockMaterial == Material.field_151579_a || p_150857_1_ == Blocks.fire || p_150857_1_ == Blocks.portal;
        }
        ...
        public void func_150859_c()
        {
            for (int i = 0; i < this.field_150868_h; ++i)
            {
                ...
                {
                    this.world.func_180501_a(blockpos.up(j), Blocks.portal.func_176223_P().withProperty(BlockPortal.AXIS, this.axis), 2);
                }
            }
        }
    }
