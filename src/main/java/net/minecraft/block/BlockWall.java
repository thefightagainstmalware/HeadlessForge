...
public class BlockWall extends Block
{
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        return block == Blocks.field_180401_cv ? false : (block != this && !(block instanceof BlockFenceGate) ? (block.blockMaterial.isOpaque() && block.func_149686_d() ? block.blockMaterial != Material.gourd : false) : true);
    }
    ...
    {
        return this.func_176223_P().withProperty(VARIANT, BlockWall.EnumType.byMetadata(meta));
    }
    ...
    {
        return state.withProperty(UP, Boolean.valueOf(!worldIn.func_175623_d(pos.up()))).withProperty(NORTH, Boolean.valueOf(this.canConnectTo(worldIn, pos.north()))).withProperty(EAST, Boolean.valueOf(this.canConnectTo(worldIn, pos.east()))).withProperty(SOUTH, Boolean.valueOf(this.canConnectTo(worldIn, pos.south()))).withProperty(WEST, Boolean.valueOf(this.canConnectTo(worldIn, pos.west())));
    }
