...
public class BlockJukebox extends BlockContainer
{
    ...
    public void insertRecord(World worldIn, BlockPos pos, IBlockState state, ItemStack recordStack)
    {
        if (!worldIn.isRemote)
        {
            ...
            {
                ((BlockJukebox.TileEntityJukebox)tileentity).setRecord(new ItemStack(recordStack.func_77973_b(), 1, recordStack.getMetadata()));
                worldIn.func_180501_a(pos, state.withProperty(HAS_RECORD, Boolean.valueOf(true)), 2);
            }
        }
    }
        ...
        if (!worldIn.isRemote)
        {
            ...
            if (tileentity instanceof BlockJukebox.TileEntityJukebox)
            {
                ...
                if (itemstack != null)
                {
                    ...
                    EntityItem entityitem = new EntityItem(worldIn, (double)pos.func_177958_n() + d0, (double)pos.func_177956_o() + d1, (double)pos.func_177952_p() + d2, itemstack1);
    ...
    public int getComparatorInputOverride(World worldIn, BlockPos pos)
    {
        ...
        if (tileentity instanceof BlockJukebox.TileEntityJukebox)
        {
            ...
            if (itemstack != null)
            {
                return Item.getIdFromItem(itemstack.func_77973_b()) + 1 - Item.getIdFromItem(Items.record_13);
            }
        }
    ...
    {
        return this.func_176223_P().withProperty(HAS_RECORD, Boolean.valueOf(meta > 0));
    }
    ...
    public static class TileEntityJukebox extends TileEntity
    {
        ...
        public void func_145839_a(NBTTagCompound compound)
        {
            ...
            if (compound.func_150297_b("RecordItem", 10))
            {
                this.setRecord(ItemStack.loadItemStackFromNBT(compound.func_74775_l("RecordItem")));
            }
        ...
        public void func_145841_b(NBTTagCompound compound)
        {
            ...
            {
                compound.func_74782_a("RecordItem", this.getRecord().writeToNBT(new NBTTagCompound()));
            }
        }
