...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider
{
    ...
    protected IBlockState getPoweredState(IBlockState unpoweredState)
    {
        ...
        return Blocks.field_150455_bV.func_176223_P().withProperty(FACING, enumfacing).withProperty(POWERED, obool).withProperty(MODE, blockredstonecomparator$mode);
    }
    ...
    protected IBlockState getUnpoweredState(IBlockState poweredState)
    {
        ...
        return Blocks.field_150441_bU.func_176223_P().withProperty(FACING, enumfacing).withProperty(POWERED, obool).withProperty(MODE, blockredstonecomparator$mode);
    }
    ...
    {
        List<EntityItemFrame> list = worldIn.<EntityItemFrame>getEntitiesWithinAABB(EntityItemFrame.class, new AxisAlignedBB((double)pos.func_177958_n(), (double)pos.func_177956_o(), (double)pos.func_177952_p(), (double)(pos.func_177958_n() + 1), (double)(pos.func_177956_o() + 1), (double)(pos.func_177952_p() + 1)), new Predicate<Entity>()
        {
    ...
    {
        if (!playerIn.field_71075_bZ.allowEdit)
        {
            return false;
        }
        else
        {
            ...
            worldIn.playSoundEffect((double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, "random.click", 0.3F, state.getValue(MODE) == BlockRedstoneComparator.Mode.SUBTRACT ? 0.55F : 0.5F);
    ...
    private void onStateChange(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (j != i || state.getValue(MODE) == BlockRedstoneComparator.Mode.COMPARE)
        {
            ...
            if (flag && !flag1)
            {
                worldIn.func_180501_a(pos, state.withProperty(POWERED, Boolean.valueOf(false)), 2);
            }
            else if (!flag && flag1)
            {
                worldIn.func_180501_a(pos, state.withProperty(POWERED, Boolean.valueOf(true)), 2);
            }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        {
            worldIn.func_180501_a(pos, this.getUnpoweredState(state).withProperty(POWERED, Boolean.valueOf(true)), 4);
        }
    ...
    {
        return this.func_176223_P().withProperty(FACING, EnumFacing.getHorizontal(meta)).withProperty(POWERED, Boolean.valueOf((meta & 8) > 0)).withProperty(MODE, (meta & 4) > 0 ? BlockRedstoneComparator.Mode.SUBTRACT : BlockRedstoneComparator.Mode.COMPARE);
    }
    ...
    {
        return this.func_176223_P().withProperty(FACING, placer.getHorizontalFacing().getOpposite()).withProperty(POWERED, Boolean.valueOf(false)).withProperty(MODE, BlockRedstoneComparator.Mode.COMPARE);
    }
