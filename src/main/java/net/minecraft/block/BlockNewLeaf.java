...
public class BlockNewLeaf extends BlockLeaves
{
    ...
    {
        return new ItemStack(Item.func_150898_a(this), 1, ((BlockPlanks.EnumType)state.getValue(VARIANT)).getMetadata() - 4);
    }
    ...
    {
        return this.func_176223_P().withProperty(VARIANT, this.getWoodType(meta)).withProperty(DECAYABLE, Boolean.valueOf((meta & 4) == 0)).withProperty(CHECK_DECAY, Boolean.valueOf((meta & 8) > 0));
    }
    ...
    public void harvestBlock(World worldIn, EntityPlayer player, BlockPos pos, IBlockState state, TileEntity te)
    {
        if (!worldIn.isRemote && player.func_71045_bC() != null && player.func_71045_bC().func_77973_b() == Items.shears)
        {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(Item.func_150898_a(this), 1, ((BlockPlanks.EnumType)state.getValue(VARIANT)).getMetadata() - 4));
        }
        else
        {
