...
public class BlockSapling extends BlockBush implements IGrowable
{
    ...
    public void grow(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        {
            worldIn.func_180501_a(pos, state.cycleProperty(STAGE), 4);
        }
        else
        {
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        switch ((BlockPlanks.EnumType)state.getValue(TYPE))
        {
            ...
            case JUNGLE:
                IBlockState iblockstate = Blocks.log.func_176223_P().withProperty(BlockOldLog.VARIANT, BlockPlanks.EnumType.JUNGLE);
                IBlockState iblockstate1 = Blocks.leaves.func_176223_P().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.JUNGLE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                label269:
        ...
        if (flag)
        {
            worldIn.func_180501_a(pos.add(i, 0, j), iblockstate2, 4);
            worldIn.func_180501_a(pos.add(i + 1, 0, j), iblockstate2, 4);
            worldIn.func_180501_a(pos.add(i, 0, j + 1), iblockstate2, 4);
            worldIn.func_180501_a(pos.add(i + 1, 0, j + 1), iblockstate2, 4);
        }
        else
        {
        ...
        if (!worldgenerator.generate(worldIn, rand, pos.add(i, 0, j)))
        {
            if (flag)
            {
                worldIn.func_180501_a(pos.add(i, 0, j), state, 4);
                worldIn.func_180501_a(pos.add(i + 1, 0, j), state, 4);
                worldIn.func_180501_a(pos.add(i, 0, j + 1), state, 4);
                worldIn.func_180501_a(pos.add(i + 1, 0, j + 1), state, 4);
            }
            else
            {
    ...
    public boolean isTypeAt(World worldIn, BlockPos pos, BlockPlanks.EnumType type)
    {
        ...
        return iblockstate.func_177230_c() == this && iblockstate.getValue(TYPE) == type;
    }
    ...
    {
        return this.func_176223_P().withProperty(TYPE, BlockPlanks.EnumType.byMetadata(meta & 7)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
    }
