...
public abstract class BlockStoneSlab extends BlockSlab
{
    ...
    {
        if (itemIn != Item.func_150898_a(Blocks.double_stone_slab))
        {
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(VARIANT, BlockStoneSlab.EnumType.byMetadata(meta & 7));
