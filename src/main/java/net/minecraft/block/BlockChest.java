...
public class BlockChest extends BlockContainer
{
    ...
    {
        if (worldIn.func_180495_p(pos.north()).func_177230_c() == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0F, 0.9375F, 0.875F, 0.9375F);
        }
        else if (worldIn.func_180495_p(pos.south()).func_177230_c() == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0625F, 0.9375F, 0.875F, 1.0F);
        }
        else if (worldIn.func_180495_p(pos.west()).func_177230_c() == this)
        {
            this.setBlockBounds(0.0F, 0.0F, 0.0625F, 0.9375F, 0.875F, 0.9375F);
        }
        else if (worldIn.func_180495_p(pos.east()).func_177230_c() == this)
        {
    ...
    {
        return this.func_176223_P().withProperty(FACING, placer.getHorizontalFacing());
    }
    ...
    {
        EnumFacing enumfacing = EnumFacing.getHorizontal(MathHelper.func_76128_c((double)(placer.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3).getOpposite();
    ...
    public IBlockState checkForSurroundingChests(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            IBlockState iblockstate = worldIn.func_180495_p(pos.north());
            IBlockState iblockstate1 = worldIn.func_180495_p(pos.south());
            IBlockState iblockstate2 = worldIn.func_180495_p(pos.west());
            IBlockState iblockstate3 = worldIn.func_180495_p(pos.east());
            ...
            if (block != this && block1 != this)
            {
                ...
                if (block2 == this || block3 == this)
                {
                    ...
                    IBlockState iblockstate6 = worldIn.func_180495_p(blockpos1.north());
                    IBlockState iblockstate7 = worldIn.func_180495_p(blockpos1.south());
            ...
            else
            {
                ...
                IBlockState iblockstate4 = worldIn.func_180495_p(blockpos.west());
                IBlockState iblockstate5 = worldIn.func_180495_p(blockpos.east());
    ...
    public IBlockState correctFacing(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        for (Object enumfacing10 : EnumFacing.Plane.HORIZONTAL)
        {
            ...
            IBlockState iblockstate = worldIn.func_180495_p(pos.offset(enumfacing1));
        ...
        else
        {
            ...
            if (worldIn.func_180495_p(pos.offset(enumfacing2)).func_177230_c().func_149730_j())
            {
    ...
    private boolean isDoubleChest(World worldIn, BlockPos pos)
    {
        ...
        else
        {
            for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL)
            {
                ...
                if (worldIn.func_180495_p(pos.offset(enumfacing)).func_177230_c() == this)
                {
                    return true;
                }
            }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (ilockablecontainer != null)
            {
                ...
                if (this.chestType == 0)
                {
                    playerIn.func_71029_a(StatList.field_181723_aa);
                }
                else if (this.chestType == 1)
                {
                    playerIn.func_71029_a(StatList.field_181737_U);
                }
            }
    ...
    {
        return worldIn.func_180495_p(pos.up()).func_177230_c().isNormalCube();
    }

    private boolean isOcelotSittingOnChest(World worldIn, BlockPos pos)
    {
        for (Entity entity : worldIn.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB((double)pos.func_177958_n(), (double)(pos.func_177956_o() + 1), (double)pos.func_177952_p(), (double)(pos.func_177958_n() + 1), (double)(pos.func_177956_o() + 2), (double)(pos.func_177952_p() + 1))))
        {
