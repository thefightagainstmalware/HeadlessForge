...
public class Block
{
    ...
    public static final RegistryNamespacedDefaultedByKey<ResourceLocation, Block> field_149771_c = new RegistryNamespacedDefaultedByKey<ResourceLocation, Block>(AIR_ID);
    ...
    public static int func_149682_b(Block blockIn)
    {
        return field_149771_c.getIDForObject(blockIn);
    }

    /**
     * Get a unique ID for the given BlockState, containing both BlockID and metadata
     */
    public static int func_176210_f(IBlockState state)
    {
        Block block = state.func_177230_c();
        return func_149682_b(block) + (block.func_176201_c(state) << 12);
    }

    public static Block getBlockById(int id)
    {
        return (Block) field_149771_c.getObjectById(id);
    }
    ...
    public static Block func_149684_b(String name)
    {
        ...
        else
        {
            try
            {
                return (Block) field_149771_c.getObjectById(Integer.parseInt(name));
            }
    ...
    {
        return this.blockMaterial.blocksMovement() && this.func_149686_d();
    }
    ...
    {
        return this.blockMaterial.isOpaque() && this.func_149686_d() && !this.canProvidePower();
    }
    ...
    {
        return worldIn.func_180495_p(pos).func_177230_c().func_149688_o().isSolid();
    }

    public AxisAlignedBB getSelectedBoundingBox(World worldIn, BlockPos pos)
    {
        return new AxisAlignedBB((double)pos.func_177958_n() + this.minX, (double)pos.func_177956_o() + this.minY, (double)pos.func_177952_p() + this.minZ, (double)pos.func_177958_n() + this.maxX, (double)pos.func_177956_o() + this.maxY, (double)pos.func_177952_p() + this.maxZ);
    }
    ...
    protected void dropXpOnBlockBreak(World worldIn, BlockPos pos, int amount)
    {
        if (!worldIn.isRemote)
        {
            while (amount > 0)
            {
                ...
                amount -= i;
                worldIn.func_72838_d(new EntityXPOrb(worldIn, (double)pos.func_177958_n() + 0.5D, (double)pos.func_177956_o() + 0.5D, (double)pos.func_177952_p() + 0.5D, i));
            }
        }
    }
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end)
    {
        ...
        start = start.addVector((double)(-pos.func_177958_n()), (double)(-pos.func_177956_o()), (double)(-pos.func_177952_p()));
        end = end.addVector((double)(-pos.func_177958_n()), (double)(-pos.func_177956_o()), (double)(-pos.func_177952_p()));
        ...
        else
        {
            ...
            return new MovingObjectPosition(vec36.addVector((double)pos.func_177958_n(), (double)pos.func_177956_o(), (double)pos.func_177952_p()), enumfacing, pos);
        }
    }
    ...
    {
        return point == null ? false : point.field_72448_b >= this.minY && point.field_72448_b <= this.maxY && point.field_72449_c >= this.minZ && point.field_72449_c <= this.maxZ;
    }
    ...
    {
        return point == null ? false : point.field_72450_a >= this.minX && point.field_72450_a <= this.maxX && point.field_72449_c >= this.minZ && point.field_72449_c <= this.maxZ;
    }
    ...
    {
        return point == null ? false : point.field_72450_a >= this.minX && point.field_72450_a <= this.maxX && point.field_72448_b >= this.minY && point.field_72448_b <= this.maxY;
    }
    ...
    {
        return worldIn.func_180495_p(pos).func_177230_c().blockMaterial.isReplaceable();
    }
    ...
    {
        player.func_71029_a(StatList.mineBlockStatArray[func_149682_b(this)]);
    ...
    {
        return this.func_149686_d() && !this.isBlockContainer;
    }
    ...
    {
        return !this.blockMaterial.isSolid() && !this.blockMaterial.func_76224_d();
    }
    ...
    {
        return this.damageDropped(worldIn.func_180495_p(pos));
    }
    ...
    {
        return "Block{" + field_149771_c.getNameForObject(this) + "}";
    }
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(53, "oak_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK))).setUnlocalizedName("stairsWood"));
        ...
        registerBlock(67, "stone_stairs", (new BlockStairs(block.func_176223_P())).setUnlocalizedName("stairsStone"));
        ...
        registerBlock(108, "brick_stairs", (new BlockStairs(block5.func_176223_P())).setUnlocalizedName("stairsBrick"));
        registerBlock(109, "stone_brick_stairs", (new BlockStairs(block8.func_176223_P().withProperty(BlockStoneBrick.VARIANT, BlockStoneBrick.EnumType.DEFAULT))).setUnlocalizedName("stairsStoneBrickSmooth"));
        ...
        registerBlock(114, "nether_brick_stairs", (new BlockStairs(block10.func_176223_P())).setUnlocalizedName("stairsNetherBrick"));
        ...
        registerBlock(128, "sandstone_stairs", (new BlockStairs(block2.func_176223_P().withProperty(BlockSandStone.TYPE, BlockSandStone.EnumType.SMOOTH))).setUnlocalizedName("stairsSandStone"));
        ...
        registerBlock(134, "spruce_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.SPRUCE))).setUnlocalizedName("stairsWoodSpruce"));
        registerBlock(135, "birch_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.BIRCH))).setUnlocalizedName("stairsWoodBirch"));
        registerBlock(136, "jungle_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.JUNGLE))).setUnlocalizedName("stairsWoodJungle"));
        ...
        registerBlock(156, "quartz_stairs", (new BlockStairs(block11.func_176223_P().withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT))).setUnlocalizedName("stairsQuartz"));
        ...
        registerBlock(163, "acacia_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.ACACIA))).setUnlocalizedName("stairsWoodAcacia"));
        registerBlock(164, "dark_oak_stairs", (new BlockStairs(block1.func_176223_P().withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.DARK_OAK))).setUnlocalizedName("stairsWoodDarkOak"));
        ...
        registerBlock(180, "red_sandstone_stairs", (new BlockStairs(block12.func_176223_P().withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.SMOOTH))).setUnlocalizedName("stairsRedSandStone"));
        ...
        field_149771_c.validateKey();


        for (Block b : field_149771_c)
        {
            if (b.blockMaterial == Material.field_151579_a)
            {
                b.useNeighborBrightness = false;
            }
            else
            {
                boolean flag = false;
                boolean flag1 = b instanceof BlockStairs;
                boolean flag2 = b instanceof BlockSlab;
                boolean flag3 = b == block6;
                boolean flag4 = b.translucent;
                boolean flag5 = b.lightOpacity == 0;
        ...
        for (Block block14 : field_149771_c)
        {
            ...
            {
                int i = field_149771_c.getIDForObject(block14) << 4 | block14.func_176201_c(iblockstate);
                if (i < 0) {
                    continue;
                }
                BLOCK_STATE_IDS.func_148746_a(iblockstate, i);
            }
        }
    }
    ...
    {
        field_149771_c.register(id, textualID, block_);
    }
