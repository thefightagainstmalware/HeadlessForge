...
public class BlockBrewingStand extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityBrewingStand)
            {
                ...
                playerIn.func_71029_a(StatList.field_181729_M);
            }
    ...
    {
        double d0 = (double)((float)pos.func_177958_n() + 0.4F + rand.nextFloat() * 0.2F);
        double d1 = (double)((float)pos.func_177956_o() + 0.7F + rand.nextFloat() * 0.3F);
        double d2 = (double)((float)pos.func_177952_p() + 0.4F + rand.nextFloat() * 0.2F);
