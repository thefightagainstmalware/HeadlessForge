...
public class BlockStairs extends Block
{
    ...
    {
        super(modelState.func_177230_c().blockMaterial);
    ...
    {
        if (worldIn.func_180495_p(pos).getValue(HALF) == BlockStairs.EnumHalf.TOP)
        {
    ...
    public int func_176307_f(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        {
            IBlockState iblockstate1 = blockAccess.func_180495_p(pos.east());
        ...
        {
            IBlockState iblockstate2 = blockAccess.func_180495_p(pos.west());
        ...
        {
            IBlockState iblockstate3 = blockAccess.func_180495_p(pos.south());
        ...
        {
            IBlockState iblockstate4 = blockAccess.func_180495_p(pos.north());
    ...
    public int func_176305_g(IBlockAccess blockAccess, BlockPos pos)
    {
        ...
        if (enumfacing == EnumFacing.EAST)
        {
            IBlockState iblockstate1 = blockAccess.func_180495_p(pos.west());
            Block block = iblockstate1.func_177230_c();
        ...
        {
            IBlockState iblockstate2 = blockAccess.func_180495_p(pos.east());
            Block block1 = iblockstate2.func_177230_c();
        ...
        {
            IBlockState iblockstate3 = blockAccess.func_180495_p(pos.north());
            Block block2 = iblockstate3.func_177230_c();
        ...
        {
            IBlockState iblockstate4 = blockAccess.func_180495_p(pos.south());
            Block block3 = iblockstate4.func_177230_c();
    ...
    {
        this.onNeighborBlockChange(worldIn, pos, this.modelState, Blocks.field_150350_a);
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(HALF, (meta & 4) > 0 ? BlockStairs.EnumHalf.TOP : BlockStairs.EnumHalf.BOTTOM);
