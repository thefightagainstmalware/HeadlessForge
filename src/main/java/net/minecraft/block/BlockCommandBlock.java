...
public class BlockCommandBlock extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (tileentity instanceof TileEntityCommandBlock)
        {
            ...
            if (!worldIn.isRemote)
            {
                commandblocklogic.setTrackOutput(worldIn.func_82736_K().func_82766_b("sendCommandFeedback"));
            }
        }
    }
    ...
    {
        return this.func_176223_P().withProperty(TRIGGERED, Boolean.valueOf((meta & 1) > 0));
    }
    ...
    {
        return this.func_176223_P().withProperty(TRIGGERED, Boolean.valueOf(false));
    }
}
