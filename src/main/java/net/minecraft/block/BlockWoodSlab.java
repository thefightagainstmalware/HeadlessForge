...
public abstract class BlockWoodSlab extends BlockSlab
{
    ...
    {
        if (itemIn != Item.func_150898_a(Blocks.double_wooden_slab))
        {
    ...
    {
        IBlockState iblockstate = this.func_176223_P().withProperty(VARIANT, BlockPlanks.EnumType.byMetadata(meta & 7));
