...
public abstract class BlockRailBase extends Block
{
    ...
    {
        return isRailBlock(worldIn.func_180495_p(pos));
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = iblockstate.func_177230_c() == this ? (BlockRailBase.EnumRailDirection)iblockstate.getValue(this.getShapeProperty()) : null;
    ...
    public class Rail
    {
        ...
        public Rail(World worldIn, BlockPos pos, IBlockState state)
        {
            ...
            this.pos = pos;
            this.state = state;
            this.block = (BlockRailBase)state.func_177230_c();
        ...
        {
            return BlockRailBase.isRailBlock(this.world, pos) || BlockRailBase.isRailBlock(this.world, pos.up()) || BlockRailBase.isRailBlock(this.world, pos.func_177977_b());
        }
        ...
        public BlockRailBase.Rail func_180364_a(boolean p_180364_1_, boolean p_180364_2_)
        {
            ...
            if (p_180364_2_ || this.world.func_180495_p(this.pos) != this.state)
            {
                this.world.func_180501_a(this.pos, this.state, 3);
