...
public class PacketBuffer extends ByteBuf
{
    ...
    public void writeItemStackToBuffer(ItemStack stack)
    {
        ...
        {
            this.writeShort(Item.getIdFromItem(stack.func_77973_b()));
            this.writeByte(stack.field_77994_a);
            this.writeShort(stack.getMetadata());
            NBTTagCompound nbttagcompound = null;

            if (stack.func_77973_b().isDamageable() || stack.func_77973_b().getShareTag())
            {
    ...
    public ItemStack readItemStackFromBuffer() throws IOException
    {
        ...
        if (i >= 0)
        {
            ...
            itemstack.func_77982_d(this.readNBTTagCompoundFromBuffer());
        }
